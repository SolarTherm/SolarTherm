...
model Hybrid_CSP_PV_Particle
  ...
  parameter Real CSP_fraction = 1.00669129153 "Fraction of the hybrid system that is CSP nameplate";
  parameter Real CSP_fraction_final(fixed = false);
  parameter Real PV_fraction = 0.241188 "Fraction of the hybrid system that is PV nameplate";
  ...
  parameter Real SM = 1.81287224691 "[SYS] Solar multiple";
  ...
  /*
                                                                            ...
                                                                            */
  parameter Real PB_fraction = 0.883254;
  ...
  parameter Real t_storage(unit = "h") = 15.024476 "[ST] Storage capacity";
