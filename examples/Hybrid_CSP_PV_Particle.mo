...
model Hybrid_CSP_PV_Particle
  ...
  SolarTherm.Models.UtilitiesComponent.SimpleElectricalHeater simpleElectricalHeater(W_dumped = if P_heater > 1 then P_heater else 0) annotation(
...
//************************************ End of The System Model ********************************************\\
  ...
  connect(tankCold.fluid_b, liftHeater.fluid_a) annotation(
    Line(points = {{44, -24}, {44, -24}, {44, -80}, {80, -80}, {80, -130}, {52, -130}, {52, -130}}, color = {0, 85, 0}, thickness = 1));
  ...
  connect(simpleElectricalHeater.particle_port_out, tankHot.fluid_a) annotation(
    Line(points = {{-42, -122}, {-58, -122}, {-58, -108}, {-22, -108}, {-22, -56}, {10, -56}, {10, 68}, {16, 68}, {16, 70}}, color = {0, 85, 0}, thickness = 1));
  connect(electrolyser.W_dumped, simpleElectricalHeater.W_electric) annotation(
    Line(points = {{238, -62}, {256, -62}, {256, -96}, {-12, -96}, {-12, -114}, {-12, -114}}, color = {0, 85, 0}, thickness = 1));
protected
  annotation(
