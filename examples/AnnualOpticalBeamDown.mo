...
import metadata = SolarTherm.Utilities.Metadata_Optics;
  ...
  parameter nSI.Angle_deg rim_angle_y=-1 "rim angle of the hyperboloid and heliostat field in the yOz plan in degree";
  ...
  parameter SI.Efficiency rho_beamdown = 0.95 "reflectivity of the secondary reflector (hyperboloid) and CPC";
