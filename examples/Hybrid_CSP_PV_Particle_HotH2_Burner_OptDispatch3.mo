...
model Hybrid_CSP_PV_Particle_HotH2_Burner_OptDispatch3
  ...
  parameter Real PV_fraction = 7.009613927830761 "Fraction of the hybrid system that is PV nameplate";
  parameter SI.Power P_hybrid_system = 4616154908.210112 "Hybrid system nameplate [W] --> allow to be oversized";
  parameter Real t_storage_H2(unit = "h") = 34.69226181725611 "[ST] H2 Storage capacity";
  parameter Real t_storage(unit = "h") = 33.55924129651824 "[ST] Storage capacity";
  parameter Real PB_fraction = 0.5392835113868507;
  parameter Real upstreammultiplier_change = 23.91363413995767 "The multiplier controlled by the optimisation, and passed";
  ...
  SolarTherm.Models.Storage.Tank.Tank_H2 tank_H2(E_tank_capacity = E_H2_tank, H2_demand = H2_mdot_tank, H2_demand_emergency = H2_mdot_tank_emergency, LHV_H2 = LHV_H2, t_storage = t_storage_H2_final, on_dispatch_optimiser_dual_tank = set_dispatch_optimiser_dual_tank, L_start = split_cold * 100) annotation(
