...
model Hybrid_CSP_PV_Particle_HotH2_Burner_OptDispatch3
  ...
  parameter Real PV_fraction = 0.0557836360791 "Fraction of the hybrid system that is PV nameplate";
  parameter SI.Power P_hybrid_system = 2477925543.06 "Hybrid system nameplate [W] --> allow to be oversized";
  parameter Real t_storage_H2(unit = "h") = 42.3817159177 "[ST] H2 Storage capacity";
  parameter Real t_storage(unit = "h") = 33.4782977162 "[ST] Storage capacity";
  parameter Real PB_fraction = 0.2;
  parameter Real upstreammultiplier_change = 9.28563718264 "The multiplier controlled by the optimisation, and passed";
