...
model PhysicalParticleCO21D_1stApproach_OptimalDispatch
...
//PowerBlock connections
  ...
  annotation(
    ...
    experiment(StopTime = 1.5768e+07, StartTime = 0, Tolerance = 1e-06, Interval = 3600),
...
end PhysicalParticleCO21D_1stApproach_OptimalDispatch;