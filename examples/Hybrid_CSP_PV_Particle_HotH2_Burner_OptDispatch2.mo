...
model Hybrid_CSP_PV_Particle_HotH2_Burner_OptDispatch2
  ...
  parameter Boolean set_no_thermal = true "If true, then turn off PB, electrical heater, indirect particle gas HX";
  ...
  parameter Real upstreammultiplier_change = 5.535236063 "The multiplier controlled by the optimisation, and passed";
  ...
  parameter SI.Power P_hybrid_system = 2015060173 "Hybrid system nameplate [W] --> allow to be oversized";
  ...
  parameter Real PV_fraction = 7.052925324 "Fraction of the hybrid system that is PV nameplate";
  parameter Real PV_fraction_final(fixed = false);
  parameter SI.Power P_CSP = if use_g3p3_field then 907106112.341903 else CSP_fraction_final * P_hybrid_system_final / upstreammultiplier "[PB] Power block net rating at design point [W]";
  ...
  parameter SI.HeatFlowRate Q_in_rcv = if use_g3p3_field then 907106112.341903 else if P_CSP > 0 then (P_CSP / eff_blk + Q_HX_industrial) / eta_rcv_assumption * SM else (P_gross / eff_blk + Q_HX_industrial) / eta_rcv_assumption * SM "Incident heat flow rate to the receiver at design point [Wth]";
  ...
  parameter Real PB_fraction = 0.9125181806;
  ...
  parameter Real t_storage(unit = "h") = 24.81783892 "[ST] Storage capacity";
  ...
  parameter Real t_storage_H2(unit = "h") = 24.76911718 "[ST] H2 Storage capacity";
  ...
  parameter SI.Length H_rcv = if use_g3p3_field then 28.757315 else sqrt(A_rcv * ar_rec) "Receiver aperture height";
  parameter SI.Length W_rcv = if use_g3p3_field then 30.980541 else A_rcv / H_rcv "Receiver aperture width";
  ...
  /******************************************************************************************************
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      parameter SI.Length t_tuffcrete47 = 0.01;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ******************************************************************************************************/
  parameter FI.Money C_storage =  if abs(P_net - P_net_default_value) < 1 or set_no_thermal then 
                                            0 
                                  else if set_dome_storage then 
                                          (C_bins_dome + C_particles + C_lift_hx + C_lift_cold + 0 + f_loss * t_life * pri_particle * 0) * upstreammultiplier 
                                  else 
                                          (C_bins + C_particles + C_lift_hx + C_lift_cold + C_insulation + f_loss * t_life * pri_particle * 1.753e10) * upstreammultiplier "Total storage cost. Dome storage bin cost calculation already considers insulation (refractory) s.t. C_insulation = 0";
  //******************************* Cost of H2 storage
...
//T_in_gas_DP_H2 = reactorRecuperator.T_H2_after_recup;
  H_tower_final = if use_g3p3_field then 244.437473 else H_tower "[H&T] Tower height";
