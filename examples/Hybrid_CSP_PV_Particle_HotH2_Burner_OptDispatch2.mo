...
model Hybrid_CSP_PV_Particle_HotH2_Burner_OptDispatch2
  ...
  parameter Real PV_fraction = 1.310383 "Fraction of the hybrid system that is PV nameplate";
  parameter SI.Power P_hybrid_system = 2.070480e+09 "Hybrid system nameplate [W] --> allow to be oversized";
  parameter Real t_storage_H2(unit = "h") = 24.638140 "[ST] H2 Storage capacity";
  parameter Real t_storage(unit = "h") = 15.0 "[ST] Storage capacity";
  parameter Real PB_fraction = 0.1;
  parameter Real upstreammultiplier_change = 2.988645095 "The multiplier controlled by the optimisation, and passed";
  ...
  parameter SI.Mass m_max = m_flow_blk * t_storage * 3600 "Max particles mass in tanks [kg]";
