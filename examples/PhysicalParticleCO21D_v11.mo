...
model PhysicalParticleCO21D_v11
...
equation
  ...
  der(E_recv_incident) = particleReceiver1D_v11.heat.Q_flow;
...
//PowerBlock connections
  ...
  connect(Tamb_input.y, particleReceiver1D_v11.Tamb) annotation(
    Line(points = {{120, 80}, {-28, 80}, {-28, 50}, {-28, 50}}, color = {0, 0, 127}));
  connect(temperature.fluid_a, particleReceiver1D_v11.fluid_b) annotation(
    Line(points = {{-16, 68}, {-16, 68}, {-16, 44}, {-20, 44}, {-20, 42}}, color = {0, 127, 255}));
  connect(heliostatsField.heat, particleReceiver1D_v11.heat) annotation(
    Line(points = {{-56, 28}, {-50, 28}, {-50, 38}, {-50, 38}}, color = {191, 0, 0}));
  connect(heliostatsField.on, particleReceiver1D_v11.on) annotation(
    Line(points = {{-72, 2}, {-32, 2}, {-32, 12}, {-32, 12}}, color = {255, 0, 255}));
  connect(liftRC.fluid_b, particleReceiver1D_v11.fluid_a) annotation(
    Line(points = {{-8, -26}, {-24, -26}, {-24, 12}, {-24, 12}}, color = {0, 127, 255}));
  annotation(
