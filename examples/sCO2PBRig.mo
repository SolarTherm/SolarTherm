...
model sCO2PBRig
  ...
  parameter SI.Temperature T_hot_set = from_degC(800) "Particle inlet temperature from particle heat exchanger at design";
  ...
  parameter SI.Temperature T_amb_input = from_degC(0);
  parameter SI.Temperature T_HTF_in = from_degC(700);
  parameter SI.MassFlowRate m_HTF_in = 600;
