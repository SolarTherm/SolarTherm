...
model PhysicalParticleCO21D_1stApproach_SurrogateReceiverMultiAperture_OnTheFlySurrogate
  ...
  parameter String rcv_type = "multi-aperture-parallel" "[RCV] other options are : flat, cylindrical, stl";
  ...
  //********************* Receiver Design Condition Sizing Calculator - Left rcv
  SolarTherm.Models.CSP.CRS.Receivers.ParticleReceiver1DCalculator particleReceiver1DCalculator_1(
  ...
  SolarTherm.Models.CSP.CRS.Receivers.ParticleReceiver1DCalculator particleReceiver1DCalculator_2(
      T_out_design = T_in_ref_blk, 
      T_in_design = T_in_rec, 
      T_amb_design = T_amb_des_rcv, 
      Wspd_design = 0, 
  ...
  SolarTherm.Models.CSP.CRS.Receivers.ParticleReceiver1DCalculator particleReceiver1DCalculator_3(
      T_out_design = T_in_ref_blk, 
      T_in_design = T_in_rec, 
      T_amb_design = T_amb_des_rcv, 
      Wspd_design = 0, 
  ...
  SolarTherm.Models.CSP.CRS.Receivers.ParticleReceiver1DCalculator defocuscalculator_1(
      T_out_design = T_in_ref_blk, 
      T_in_design = T_in_rec, 
      T_amb_design = T_amb_des_rcv, 
      Wspd_design = 0, 
      ...
      m_design = m_flow_blk * (Q_in_lv1/Q_in_rcv),  //Fraction of the mass flow rate that goes into the left receiver
      H_drop_design = H_rcv_lv1, 
      with_pre_determined_eta = false,
      N = discretisations,
      with_catch_and_release_mechanism = with_catch_and_release_mechanism
  ...
  SolarTherm.Models.CSP.CRS.Receivers.ParticleReceiver1DCalculator defocuscalculator_2(
      T_out_design = T_in_ref_blk, 
      T_in_design = T_in_rec, 
      T_amb_design = T_amb_des_rcv, 
      Wspd_design = 0, 
      ...
      iterate_Q_flow = true, 
      with_iterate_mdot = false, 
      m_design = m_flow_blk * (Q_in_lv2/Q_in_rcv),  //Fraction of the mass flow rate that goes into the left receiver
      H_drop_design = H_rcv_lv2, 
      with_pre_determined_eta = false,
      N = discretisations,
      with_catch_and_release_mechanism = with_catch_and_release_mechanism
  ...
  SolarTherm.Models.CSP.CRS.Receivers.ParticleReceiver1DCalculator defocuscalculator_3(
      T_out_design = T_in_ref_blk, 
      T_in_design = T_in_rec, 
      T_amb_design = T_amb_des_rcv, 
      Wspd_design = 0, 
      ...
      iterate_Q_flow = true, 
      with_iterate_mdot = false, 
      m_design = m_flow_blk * (Q_in_lv3/Q_in_rcv),  //Fraction of the mass flow rate that goes into the left receiver
      H_drop_design = H_rcv_lv3, 
      with_pre_determined_eta = false,
      N = discretisations,
      with_catch_and_release_mechanism = with_catch_and_release_mechanism
...
initial equation
  ...
  rec_fr = 1 - (particleReceiver1DCalculator_1.particleReceiver1D.eta_rec + particleReceiver1DCalculator_2.particleReceiver1D.eta_rec + particleReceiver1DCalculator_3.particleReceiver1D.eta_rec)/3;
  m_flow_fac = particleReceiver1DCalculator_1.particleReceiver1D.mdot + particleReceiver1DCalculator_2.particleReceiver1D.mdot + particleReceiver1DCalculator_3.particleReceiver1D.mdot ;
  
  Q_flow_defocus_calculated_lv1 = defocuscalculator_1.Q_in_rcv_calculated;
  Q_flow_defocus_calculated_lv2 = defocuscalculator_2.Q_in_rcv_calculated;
  Q_flow_defocus_calculated_lv3 = defocuscalculator_3.Q_in_rcv_calculated;
...
//************************************ Equations below exist to close the model
  ...
  particleReceiver.ratio_1 = heliostatsField.ratio_1 "Equation to close the system model";
  particleReceiver.ratio_2 = heliostatsField.ratio_2 "Equation to close the system model";
  particleReceiver.ratio_3 = heliostatsField.ratio_3 "Equation to close the system model";
...
//************************************ Dispatch optimiser variables
  ...
  der(E_recv_incident) = particleReceiver.Q_in_1 + particleReceiver.Q_in_2 + particleReceiver.Q_in_3;
  der(E_recv_net) = particleReceiver.Q_rcv_1 + particleReceiver.Q_rcv_2 + particleReceiver.Q_rcv_3;
