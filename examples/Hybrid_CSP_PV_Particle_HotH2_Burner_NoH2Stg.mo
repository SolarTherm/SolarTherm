...
model Hybrid_CSP_PV_Particle_HotH2_Burner_NoH2Stg
  ...
  parameter SI.MassFlowRate H2_mdot_feedstock = 0.42925 "H2 mass flow rate taht will be consumed by the reactor regardless the operating temperature of the reactor is. Equivalent to 0.25 million ton of Fe per year";
  ...
  parameter SI.MassFlowRate H2_mdot_HX = H2_mdot_feedstock + H2_mdot_recycle "Mass flow rate of the H2 going to the reactor";
  ...
  parameter SI.MassFlowRate H2_mdot_tank = H2_mdot_feedstock + H2_mdot_burner "Mass flow rate that has to be drawn from the hydrogen storage tank -- a sum of H2 feedstock and H2 for burner (if burner is used)";
  ...
  parameter SI.Power P_hybrid_system = 200e6 "Hybrid system nameplate [W] --> allow to be oversized";
  ...
  parameter SI.Temperature T_in_gas_off_H2 = T_in_gas_DP_H2 "Design inlet temperature of the gas [K]";
  ...
  parameter Real t_storage_H2(unit = "h") = 2.053482031 "[ST] H2 Storage capacity";
  ...
  parameter FI.Money C_recuperator_H2 = pri_recup_gas_to_gas * UA_recup "Price of the H2 recuperators";
  //******************************* Price of the H2 burner
  parameter FI.Money C_burner = pri_gas_burner * Q_burner / 1e3 "Price of gas burner";
  //******************************* Cost of BOP
  ...
  Modelica.Blocks.Math.Sum sumH2(nin = 2) annotation(
    Placement(visible = true, transformation(origin = {294, -118}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  //********************* Variables
  ...
  SolarTherm.Models.UtilitiesComponent.H2_splitter h2_splitter(mdot_split = H2_mdot_burner, mdot_recycle = H2_mdot_recycle) annotation(
    Placement(visible = true, transformation(origin = {409, -299}, extent = {{69, -69}, {-69, 69}}, rotation = 0)));
  ...
  SolarTherm.Models.UtilitiesComponent.H2_splitter h2_splitter1(mdot_recycle = H2_mdot_recycle, mdot_split = H2_mdot_tank) annotation(
    Placement(visible = true, transformation(origin = {377, -77}, extent = {{-39, -39}, {39, 39}}, rotation = 0)));
  Modelica.Blocks.Logical.GreaterEqualThreshold greaterEqualThreshold(threshold = H2_mdot_tank) annotation(
    Placement(visible = true, transformation(origin = {444, -196}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
algorithm
...
//********************************* Cost of the indirect particle-gas-HX between particle and H2
  C_exchanger_indirect = if f_TES < 1e-3 then 0 else pri_PHX_per_area * A_HX_H2 + pri_PHX_BOP_s * heatExchanger_ParticleGasIndirectH2.designPoint.m_dot_pcl_DP + pri_PHX_BOP_CO2 * heatExchanger_ParticleGasIndirectH2.designPoint.m_dot_gas_DP;
...
//************************************ End of The System Model ********************************************\\
  connect(SMR.H2_SMR, sumH2.u[1]) annotation(
    Line(points = {{168, -142}, {240, -142}, {240, -118}, {282, -118}}, color = {255, 0, 0}, thickness = 1));
  connect(electrolyser.H2_mdot_out, sumH2.u[2]) annotation(
    Line(points = {{238, -56}, {270, -56}, {270, -118}, {282, -118}}, color = {255, 0, 0}, thickness = 1));
  ...
  connect(h2_splitter.flow_out_2, simpleGasBurner.fuel_in) annotation(
    Line(points = {{336, -331}, {219, -331}, {219, -317}, {122, -317}}, color = {0, 0, 127}));
  connect(h2_splitter.flow_out_1, sum.u[1]) annotation(
    Line(points = {{336, -273}, {302, -273}, {302, -192}, {278, -192}}, color = {0, 0, 127}));
  ...
  connect(booleanExpression1.y, controlHot.H2_tank_charging) annotation(
    Line(points = {{212, 66}, {212, 66}, {212, 58}, {56, 58}, {56, 62}, {56, 62}}, color = {255, 0, 255}));
  connect(sumH2.y, h2_splitter1.flow_in) annotation(
    Line(points = {{306, -118}, {354, -118}, {354, -76}, {334, -76}}, color = {0, 0, 127}));
  connect(h2_splitter1.flow_out_2, h2_splitter.flow_in) annotation(
    Line(points = {{418, -95}, {500, -95}, {500, -256}, {485, -256}, {485, -298}}, color = {0, 0, 127}));
  connect(h2_splitter1.flow_out_2, greaterEqualThreshold.u) annotation(
    Line(points = {{418, -95}, {476, -95}, {476, -196}, {456, -196}}, color = {0, 0, 127}));
  connect(greaterEqualThreshold.y, h2_recycle.on) annotation(
    Line(points = {{432, -196}, {392, -196}, {392, -156}, {342, -156}, {342, -174}, {340, -174}}, color = {255, 0, 255}));
  connect(greaterEqualThreshold.y, heatExchanger_ParticleGasIndirectH2.on_discharge) annotation(
    Line(points = {{432, -196}, {408, -196}, {408, -164}, {192, -164}, {192, -220}, {190, -220}}, color = {255, 0, 255}));
protected
  annotation(
...
end Hybrid_CSP_PV_Particle_HotH2_Burner_NoH2Stg;