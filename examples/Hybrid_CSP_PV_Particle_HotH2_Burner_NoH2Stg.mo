...
model Hybrid_CSP_PV_Particle_HotH2_Burner_NoH2Stg
  ...
  parameter Real f_TES = 0 "Fraction of the heat needed to heat up the H2_mdot_total to T_out_gas_DP_H2 provided by TES";
  ...
  SolarTherm.Models.UtilitiesComponent.H2_splitter h2_splitter1(mdot_recycle = H2_mdot_recycle, mdot_split = H2_mdot_tank) annotation(
    Placement(visible = true, transformation(origin = {387, -117}, extent = {{-29, -29}, {29, 29}}, rotation = 0)));
...
//************************************ End of The System Model ********************************************\\
  ...
  connect(sumH2.y, h2_splitter1.flow_in) annotation(
    Line(points = {{306, -118}, {354, -118}, {354, -116}, {356, -116}}, color = {0, 0, 127}));
  connect(h2_splitter1.flow_out_2, h2_splitter.flow_in) annotation(
    Line(points = {{418, -130}, {500, -130}, {500, -256}, {400, -256}, {400, -258}}, color = {0, 0, 127}));
  connect(h2_splitter1.flow_out_2, greaterEqualThreshold.u) annotation(
    Line(points = {{418, -130}, {476, -130}, {476, -196}, {456, -196}, {456, -196}}, color = {0, 0, 127}));
