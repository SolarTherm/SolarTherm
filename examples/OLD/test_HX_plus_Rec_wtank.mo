model test_HX_plus_Rec_wtank
  ...
  parameter SI.Temperature T_hot_set = 740+273.15 "Hot Sodium target temperature";
  parameter SI.Temperature T_cold_set = 670+273.15 "Cold Sodium target temperature";
...
//  parameter SI.MassFlowRate m_flow_fac = SM * Q_flow_des / (h_hot_set - h_cold_set) "Mass flow rate to receiver at design point";
  parameter SI.MassFlowRate m_flow_fac = 570.581 "Mass flow rate to receiver at design point";
  ...
  // Receiver
  SolarTherm.Models.CSP.CRS.Receivers.SodiumReceiver receiver(em = em_rec, redeclare package Medium = Medium1, H_rcv = H_receiver, D_rcv = D_receiver, N_pa = N_pa_rec, t_tb = t_tb_rec, D_tb = D_tb_rec, ab = ab_rec, T_out_0 = Shell_and_Tube_HX.T_Na1_0, T_in_0 = Shell_and_Tube_HX.T_Na2_0) annotation(
  ...
  //HX
  SolarTherm.Models.Fluid.HeatExchangers.HX_wi Shell_and_Tube_HX(replaceable package Medium1 = Medium1, replaceable package Medium2 = Medium2, Q_d_des = Q_flow_des * SM, Q=receiver.Q_rcv) annotation(
  ...
  SolarTherm.Models.Fluid.Sources.FluidSink MS_Sink(replaceable package Medium = Medium2) annotation(
    Placement(visible = true, transformation(origin = {132, 80}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
...
// Fluid connections
  ...
  connect(Shell_and_Tube_HX.port_b_out, MS_Sink.port_a) annotation(
    Line(points = {{62, 56}, {62, 80}, {124, 80}}, color = {0, 127, 255}));
  connect(Shell_and_Tube_HX.port_b_in, MS_inlet.ports[1]) annotation(
    Line(points = {{74, 42}, {74, 25}, {130, 25}}, color = {0, 127, 255}));
...
// controlCold connections
  ...
  connect(controlCold.defocus, heliostatsField.defocus) annotation(
    Line(points = {{54, -10}, {54, -10}, {54, -52}, {-80, -52}, {-80, 8}, {-52, 8}, {-52, 8}}, color = {255, 0, 255}));
  ...
  connect(heliostatsField.on, controlCold.sf_on) annotation(
    Line(points = {{-36, 2}, {-36, 2}, {-36, -26}, {-46, -26}, {-46, -44}, {72, -44}, {72, -8}, {60, -8}, {60, -8}}, color = {255, 0, 255}));
//Solar field connections i.e. solar.heat port and control
  ...
  connect(heliostatsField.heat, receiver.heat) annotation(
    Line(points = {{-20, 27.5}, {-54.82, 27.5}, {-54.82, 27}, {-10, 27}}, color = {191, 0, 0}));
  ...
  connect(heliostatsField.on, Shell_and_Tube_HX.HF_on) annotation(
    Line(points = {{-36, 2}, {-36, 2}, {-36, -26}, {-120, -26}, {-120, 120}, {74, 120}, {74, 56}, {74, 56}}, color = {255, 0, 255}));
  annotation(
    Diagram(coordinateSystem(extent = {{-140, -120}, {160, 140}}, initialScale = 0.1), graphics = {Text(origin = {36, 0}, lineColor = {217, 67, 180}, extent = {{-50, -40}, {-14, -40}}, textString = "on/off strategy", fontSize = 9), Text(origin = {36, 2}, extent = {{-52, 8}, {-4, -12}}, textString = "Receiver", fontSize = 14, fontName = "CMU Serif"), Text(origin = {62, 2}, extent = {{-110, 4}, {-62, -16}}, textString = "Heliostats Field", fontSize = 14, fontName = "CMU Serif", horizontalAlignment = TextAlignment.Left), Text(origin = {20, 8}, extent = {{-80, 86}, {-32, 66}}, textString = "Sun", fontSize = 14, fontName = "CMU Serif"), Text(origin = {36, -2}, extent = {{-6, 20}, {42, 0}}, textString = "Receiver Control", fontSize = 14, fontName = "CMU Serif"), Text(origin = {20, -24}, extent = {{-146, -26}, {-98, -46}}, textString = "Data Source", fontSize = 14, fontName = "CMU Serif")}),
