...
model SolarFuelSystem
	...
	parameter FI.Money C_ds_rx = FI.fischerTropschCost_m_sg(m_flow_ft_des) "fischer tropsch (downstream) reactor cost";
	...
	parameter Integer n_labor = FI.nLabour_m_sg_ft(m_flow_ft_des) "Number of labor working at the plant";
	...
	SI.VolumeFlowRate v_flow_fuel_des(min=0) "Volumetric flow rate of fuel produced at the FT at design";
	// Equations
	// *********************
initial equation
...
equation
	...
	v_flow_fuel_des = FT.v_flow_fuel_des;
