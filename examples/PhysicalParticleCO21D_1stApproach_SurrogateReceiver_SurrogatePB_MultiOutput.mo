...
model PhysicalParticleCO21D_1stApproach_SurrogateReceiver_SurrogatePB_MultiOutput
  ...
  parameter Real y_max_PB[outputsize_PB] = {0.55466685, 1.03160735};
  parameter Real y_min_PB[outputsize_PB] = {0, -0.00062179};
  parameter String saved_model_dir_PB = "/home/philgun/Documents/codecodecode/codecodecode/ML/script/sCO2_Trained_Model/final-data/surrogate_model_2";
  // Storage
  ...
  parameter SI.Temperature T_cold_set = 923.15 "Cold tank target temperature";
  parameter SI.Temperature T_hot_set = 1173.15 "Hot tank target temperature";
  ...
  // Power block
  SolarTherm.Models.PowerBlocks.SurrogatesCO2PB_MultiOutput powerBlock(P_net = P_net, T_in_ref_blk = T_hot_set, p_high = p_high, PR = PR, pinch_PHX = pinch_exchanger, dTemp_HTF_PHX = T_hot_set - T_cold_set, dTemp_HTF_PHX, Q_HX_des = Q_flow_des, m_HTF_des = m_flow_blk, inputsize = inputsize_PB, outputsize = outputsize_PB, saved_model_dir = saved_model_dir_PB, X_max = X_max_PB, X_min = X_min_PB, out_max = y_max_PB, out_min = y_min_PB, test_mode = false, eta_motor = eta_motor, f_fixed_load = f_fixed_load) annotation(
  ...
  SolarTherm.Models.PowerBlocks.sCO2PBCalculator_Using_JPidea sCO2PBDesignPointCalculator(
      ...
      dTemp_HTF_PHX = T_hot_set - T_cold_set, 
...
end PhysicalParticleCO21D_1stApproach_SurrogateReceiver_SurrogatePB_MultiOutput;