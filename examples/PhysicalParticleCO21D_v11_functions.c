...
#include "PhysicalParticleCO21D_v11_functions.h"
#ifdef __cplusplus
extern "C" {
#endif

#include "PhysicalParticleCO21D_v11_includes.h"
...
modelica_metatype boxptr_Modelica_Blocks_Tables_D_CombiTable1Ds24particleReceiver1D__v1124Tab_getTableValue(threadData_t *threadData, modelica_metatype _tableID, modelica_metatype _icol, modelica_metatype _u, modelica_metatype _tableAvailable)
{
  ...
  tmp2 = mmc_unbox_real(_u);
  tmp3 = mmc_unbox_real(_tableAvailable);
  _y = omc_Modelica_Blocks_Tables_D_CombiTable1Ds24particleReceiver1D__v1124Tab_getTableValue(threadData, _tableID, tmp1, tmp2, tmp3);
  out_y = mmc_mk_rcon(_y);
  return out_y;
}
...
modelica_metatype boxptr_Modelica_Blocks_Tables_D_CombiTable1Ds24particleReceiver1D__v1124Tab_readTableData(threadData_t *threadData, modelica_metatype _tableID, modelica_metatype _forceRead, modelica_metatype _verboseRead)
{
  ...
  tmp1 = mmc_unbox_integer(_forceRead);
  tmp2 = mmc_unbox_integer(_verboseRead);
  _readSuccess = omc_Modelica_Blocks_Tables_D_CombiTable1Ds24particleReceiver1D__v1124Tab_readTableData(threadData, _tableID, tmp1, tmp2);
  out_readSuccess = mmc_mk_rcon(_readSuccess);
  return out_readSuccess;
}
...
{
  Modelica_Fluid_Interfaces_D_FluidPort__a24particleReceiver1D__v1124fluid__a_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._h = omc_h;
  return tmp1;
}
...
{
  return mmc_mk_box3(3, &Modelica_Fluid_Interfaces_D_FluidPort__a24particleReceiver1D__v1124fluid__a_Medium_ThermodynamicState__desc, _p, _h);
}
...
{
  Modelica_Fluid_Interfaces_D_FluidPort__b24particleReceiver1D__v1124fluid__b_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._h = omc_h;
  return tmp1;
}
...
{
  return mmc_mk_box3(3, &Modelica_Fluid_Interfaces_D_FluidPort__b24particleReceiver1D__v1124fluid__b_Medium_ThermodynamicState__desc, _p, _h);
}
...
void omc_Modelica_Fluid_Utilities_checkBoundary(threadData_t *threadData, modelica_string _mediumName, string_array _substanceNames, modelica_boolean _singleState, modelica_boolean _define_p, real_array _X_boundary, modelica_string _modelName)
{
  ...
  _nX = tmp1;
  {
    ...
    {
      tmpMeta[0] = stringAppend(_OMC_LIT6,_modelName);
    ...
    {
      {
        ...
        {
          tmpMeta[0] = stringAppend(_OMC_LIT9,_mediumName);
          ...
          tmpMeta[5] = stringAppend(tmpMeta[4],_OMC_LIT12);
          ...
          tmpMeta[7] = stringAppend(tmpMeta[6],_OMC_LIT13);
          {
  ...
  if(((_nX > ((modelica_integer) 0)) && (fabs(-1.0 + sum_real_array(_X_boundary)) > 1e-10)))
  {
    ...
    if(!(((tmp12 > 0) && (tmp11 > tmp13)) || ((tmp12 < 0) && (tmp11 < tmp13))))
    {
      ...
      {
        tmpMeta[0] = stringAppend(_X_str,_OMC_LIT15);
        ...
        tmpMeta[6] = stringAppend(tmpMeta[5],_OMC_LIT18);
        _X_str = tmpMeta[6];
      }
    }

    tmpMeta[0] = stringAppend(_OMC_LIT19,_mediumName);
    tmpMeta[1] = stringAppend(tmpMeta[0],_OMC_LIT10);
    tmpMeta[2] = stringAppend(tmpMeta[1],_modelName);
    tmpMeta[3] = stringAppend(tmpMeta[2],_OMC_LIT18);
    tmpMeta[4] = stringAppend(tmpMeta[3],_OMC_LIT20);
    ...
    tmpMeta[6] = stringAppend(tmpMeta[5],_OMC_LIT21);
...
modelica_real omc_Modelica_Utilities_Strings_scanReal(threadData_t *threadData, modelica_string _string, modelica_integer _startIndex, modelica_boolean _unsigned, modelica_string _message, modelica_integer *out_nextIndex)
{
  ...
  if((_nextIndex == _startIndex))
  {
    ...
    {
      tmpMeta[0] = stringAppend(_OMC_LIT29,_message);
      omc_Modelica_Utilities_Strings_syntaxError(threadData, _string, _nextIndex, tmpMeta[0]);
    }
  }
  _return: OMC_LABEL_UNUSED
...
void omc_Modelica_Utilities_Strings_syntaxError(threadData_t *threadData, modelica_string _string, modelica_integer _index, modelica_string _message)
{
  ...
  {
    tmpMeta[0] = stringAppend(_OMC_LIT31,omc_Modelica_Utilities_Strings_substring(threadData, _string, _index2 - _maxIndex, _lenString));
  ...
  {
    tmpMeta[0] = stringAppend(omc_Modelica_Utilities_Strings_substring(threadData, _errString, ((modelica_integer) 1), _maxLenString),_OMC_LIT32);
    _errString = tmpMeta[0];
  }

  tmp1 = modelica_integer_to_modelica_string(_index, ((modelica_integer) 0), 1);
  tmpMeta[0] = stringAppend(_OMC_LIT33,tmp1);
  ...
  tmpMeta[4] = stringAppend(tmpMeta[3],omc_Modelica_Utilities_Strings_repeat(threadData, ((modelica_integer) -1) + _index2, _OMC_LIT28));
  tmpMeta[5] = stringAppend(tmpMeta[4],_OMC_LIT36);
  tmpMeta[6] = stringAppend(tmpMeta[5],_OMC_LIT35);
...
{
  PhysicalParticleCO21D__v11_MedPB_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._h = omc_h;
  return tmp1;
}
...
{
  return mmc_mk_box3(3, &PhysicalParticleCO21D__v11_MedPB_ThermodynamicState__desc, _p, _h);
}
...
{
  PhysicalParticleCO21D__v11_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._h = omc_h;
  return tmp1;
}
...
{
  return mmc_mk_box3(3, &PhysicalParticleCO21D__v11_Medium_ThermodynamicState__desc, _p, _h);
}
...
modelica_real omc_SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign_D_CompressorOnShaft24powerBlock24mainCompressor_MedPB_specificEntropy(threadData_t *threadData, SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign_D_CompressorOnShaft24powerBlock24mainCompressor_MedPB_ThermodynamicState _state)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _s has no default value.
  _s = omc_SolarTherm_Media_CO2_CO2__utilities_s__p__h(threadData, _state._p, _state._h, omc_Modelica_Blocks_Types_ExternalCombiTable2D_constructor(threadData, _OMC_LIT48, _OMC_LIT49, _OMC_LIT50, 1));
  _return: OMC_LABEL_UNUSED
  return _s;
}
...
real_array omc_SolarTherm_Utilities_Metadata__Optics(threadData_t *threadData, modelica_string _file)
{
  ...
  tmpMeta[0] = stringAppend(_OMC_LIT52,_file);
