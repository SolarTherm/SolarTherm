...
model SaltSCO2System "High temperature salt-sCO2 system"
  ...
  // Receiver
  Models.CSP.CRS.Receivers.ReceiverSimple_2 receiver(em = em_rec, redeclare package Medium = Medium, H_rcv = H_receiver, D_rcv = D_receiver, N_pa = N_pa_rec, t_tb = t_tb_rec, D_tb = D_tb_rec, ab = ab_rec) annotation(
