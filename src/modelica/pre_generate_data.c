...
int main()
{
    ...
    double eta_isen_t;
    char* SolarTherm_path = "/home/arfontalvo/program_files/na_salt_hx/SolarTherm";
    char* base_path = "/home/arfontalvo/program_files/na_salt_hx/SolarTherm/Resources/Include";
