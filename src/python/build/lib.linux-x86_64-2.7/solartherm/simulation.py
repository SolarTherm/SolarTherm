...
class Simulator(object):
	...
	def simulate(self, start='0', stop='86400', step='60', tolerance = '1e-06', initStep=None, maxStep=None, integOrder=None, solver='rungekutta', nls='newton', lv='-LOG_SUCCESS,-stdout', args=[]):
		"""Run simulation.
