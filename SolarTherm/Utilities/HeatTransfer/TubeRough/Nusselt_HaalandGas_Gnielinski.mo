...
function Nusselt_HaalandGas_Gnielinski "Nu = f(Re,Pr,E/d), Nusselt number of a fluid flowing through a rough pipe"
...
end Nusselt_HaalandGas_Gnielinski;
