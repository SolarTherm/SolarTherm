...
package Currency_Conversions
  ...
  annotation(
    Icon(graphics = {Rectangle(lineColor = {200, 200, 200}, fillColor = {248, 248, 248}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, -100}, {100, 100}}, radius = 25), Line(origin = {-2, -3}, points = {{0, 61}, {0, -61}}, thickness = 1), Line(origin = {-40, -3}, points = {{0, 61}, {0, -61}}, thickness = 1), Rectangle(origin = {0, -11}, lineThickness = 1, extent = {{-72, 69}, {72, -53}}), Line(origin = {-1, 34}, points = {{-71, 0}, {73, 0}}, thickness = 1), Line(origin = {36, -4}, points = {{0, 62}, {0, -60}}, thickness = 1)}),
    Documentation(info = "<html><head></head><body><div><b>Assumptions:</b></div><div><b><br></b></div><div>Currency conversion rates used were the average rates for the calendar year obtained from the Australian Tax Office (ATO) website.</div><div><br></div><div>Replace \"2024\" with the year in question.</div><div><br></div><div>Lookup-table data is for years 2006 - 2024.&nbsp;</div><b><div><b><br></b></div>References:</b><div><b><br></b></div><div>https://www.ato.gov.au/tax-rates-and-codes/foreign-exchange-rates-annual-2024-calendar-year</div></body></html>"));
