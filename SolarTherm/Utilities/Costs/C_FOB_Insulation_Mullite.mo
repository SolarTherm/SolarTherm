...
function C_FOB_Insulation_Mullite "Free-on-board intermal mullite insulation cost based on regression. Inputs are {year, max temp (K), U_loss (W/mK), A_surf (m2)}"
