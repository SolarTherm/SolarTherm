within SolarTherm.Utilities.Costs.Components;

function C_FOB_Shell_Seider
"Free-on-board carbon steel vessel cost based on Seider 2008. Inputs are {year, shell volume (m3)}"
