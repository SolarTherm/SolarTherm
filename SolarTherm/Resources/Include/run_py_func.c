...
const char* RunSolsticeFunc(const char *ppath, const char *pname, const char *pfunc, const char *psave,  const char *field_type, const char *rcv_type, const char *wea_file, const char* sun_shape, int argc, const char *varnames[], const double var[]);
...
const char* RunSolsticeFunc(const char *ppath, const char *pname, const char *pfunc, const char *psave,  const char *field_type, const char *rcv_type, const char *wea_file, const char* sun_shape, int argc, const char *varnames[], const double var[])
{
    ...
    if (pModule != NULL) {
        ...
        if (pFunc && PyCallable_Check(pFunc)) {
            ...
            PyDict_SetItemString(inputs, "sunshape", PyString_FromString((char *)sun_shape));
            for (i = 0; i < argc; ++i) {
