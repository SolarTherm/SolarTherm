...
int run_ascend_sintering_model_CLI(const char* ppath, const char* pname, int num_segment, const double var[], const char* modelica_wd, const char* SolarTherm_path, double* angles, char* iron_sample);
