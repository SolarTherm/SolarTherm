...
int run_ascend_sintering_model(const char *ppath, const char *pname, const char *pfunc, int argc, int num_segment, const char *varnames[], const double var[], const char *modelica_wd, const char* SolarTherm_path, double* angles);
