...
if __name__=='__main__':
	...
	rec_l=10.
	H_tower = 65.
	inputs={'casedir': case, 'wea_file': weafile, 'theta_deg': theta_deg, 'rim_angle':rim_angle, 'secref_fratio':secref_fratio, 'rec_z': rec_z, 'rec_w':rec_w, 'rec_l': rec_l, 'H_tower': H_tower}
	run_simul(inputs)
