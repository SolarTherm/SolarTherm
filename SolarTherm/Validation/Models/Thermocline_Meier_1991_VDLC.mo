...
model Thermocline_Meier_1991_VDLC
  //Use hybrid
  ...
  SolarTherm.Models.Storage.Thermocline.Lumped_Capacitance.Thermocline_Spheres_SingleTank_VDLC_Final thermocline_Tank(redeclare package Medium = Medium, redeclare package Fluid_Package = Fluid, redeclare package Filler_Package = Filler, Correlation = Correlation, Tank_A.H_tank = H_tank, Tank_A.D_tank = D_tank, N_f = N_f, N_p = N_p, T_max = T_max, T_min = T_min, U_loss_tank = U_loss_tank, d_p = d_p, eta = eta) annotation(
...
end Thermocline_Meier_1991_VDLC;