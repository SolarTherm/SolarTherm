...
model Thermocline_Alonso_2022
  ...
  parameter Integer Correlation = 1; //1:Wakao-kaguei, 2:melissari-argyropoulos
  ...
  //Zebedee you left off here
  import Dataset = SolarTherm.Validation.Datasets.AlonsoFig8_DataSet;
