...
model TestSCO2PB_Zeb
  ...
  // ReceiverControl
  // Power block
  SolarTherm.Models.PowerBlocks.sCO2Cycle.DirectDesign.recompPB powerBlock(redeclare package MedRec = Medium, E_net(displayUnit = ""), PR = 2.46, P_gro = 100e6, T_HTF_in_des = 600 + 273.15, T_amb_des = blk_T_amb_des, T_high = 500 + 273.15, T_low = 45 + 273.15, eta_turb = 0.90, external_parasities = false, m_HTF_des = 1000, nu_min = nu_min_blk, p_high = 25e6) annotation(
