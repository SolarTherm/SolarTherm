...
model Thermocline_Arkar_Melting108
  ...
  package RT20_Paraffin = SolarTherm.Media.Materials.RT20_Paraffin_Melting;
...
annotation(experiment(StopTime = 50400, StartTime = 0, Tolerance = 1e-6, Interval = 180.0));
