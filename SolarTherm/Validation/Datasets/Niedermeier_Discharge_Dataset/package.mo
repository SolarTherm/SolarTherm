...
package Niedermeier_Discharge_Dataset "Provides the initial temerature and enthalpy distributions of the validation case used by Niedermeier (2018) based on Pacheco (2002) experimental data"
