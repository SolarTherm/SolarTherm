...
//Note: Modified by Zebedee Kee to curtail excess electricity such that it never exceeds nameplate value and give > 100% capacity factor
  ...
  parameter SI.HeatFlowRate W_net_des=100e6 "Design turbine net output, upper limit of net power generated";
  ...
  SI.Energy E_gross(start=0, fixed=true, displayUnit="MW.h");
...
equation
  ...
  W_net = min(W_net_des,W_gross - W_loss);
end PowerBlockModel;