...
model RecGeneric "Polynomial factors around design point"
	...
	parameter Real ci[:] "Irradiance factor coefficients";
...
protected
	SolarTherm.Utilities.Polynomial.Poly fac_irr(c=ci);
...
equation
	...
	Q_flow_loss = Q_flow_loss_des*fac_irr.y*fac_amb.y*fac_wnd.y;
	fac_irr.x = sum(R)/R_des;
