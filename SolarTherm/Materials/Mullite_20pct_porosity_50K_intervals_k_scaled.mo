...
package Mullite_20pct_porosity_50K_intervals_k_scaled
  ...
  algorithm
    k := 0.33*Modelica.Math.Vectors.interpolate(T_data, k_data, T);
  end k_Tf;
...
end Mullite_20pct_porosity_50K_intervals_k_scaled;