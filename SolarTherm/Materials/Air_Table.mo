...
package Air_Table
  ...
  equation
	//Tab.u = h;
	T = SolarTherm.Media.Air.Air_amb_p_utilities.T_h(h);
	rho = SolarTherm.Media.Air.Air_amb_p_utilities.rho_T(T);
	cp = SolarTherm.Media.Air.Air_amb_p_utilities.cp_T(T);
	mu = SolarTherm.Media.Air.Air_amb_p_utilities.mu_T(T);
	k = SolarTherm.Media.Air.Air_amb_p_utilities.k_T(T);
  end State;
  ...
  algorithm
    h := SolarTherm.Media.Air.Air_amb_p_utilities.h_T(T);
  end h_Tf;
