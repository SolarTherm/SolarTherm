...
package H2_amb_p_table
  ...
  equation
    T = SolarTherm.Media.H2.H2_amb_p_table_utilities.T_h(h);
    rho = SolarTherm.Media.H2.H2_amb_p_table_utilities.rho_T(T);
    cp = SolarTherm.Media.H2.H2_amb_p_table_utilities.cp_T(T);
    mu = SolarTherm.Media.H2.H2_amb_p_table_utilities.mu_T(T);
    k = SolarTherm.Media.H2.H2_amb_p_table_utilities.k_T(T);
  end State;
  ...
  algorithm
    h := SolarTherm.Media.H2.H2_amb_p_table_utilities.h_T(T);
  end h_Tf;
