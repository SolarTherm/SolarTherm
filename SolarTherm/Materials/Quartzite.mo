...
package Quartzite
  extends SolarTherm.Materials.PartialMaterial(MM = 60.08e-3, T_melt = 1670.0+273.15, cost = 0.050, year = 2002);
  
  //Properties of Quartzite_Sand are defined by constant cp_1, rho_1 and k_1
  constant SI.SpecificHeatCapacity cp_1 = 830.0 "Specific heat capacity of PCM solid (J/kgK)";
  constant SI.Density rho_1 = 2500.0 "Density of PCM solid (kg/m3)";
  constant SI.ThermalConductivity k_1 = 5.69 "Thermal conductivity of solid (W/mK)";
