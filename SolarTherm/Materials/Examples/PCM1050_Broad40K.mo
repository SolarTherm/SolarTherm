...
package PCM1050_Broad40K"A ficticious PCM material that melts at a broad temperature range of 20K centered around 1050degC."
  ...
  constant SI.Temperature T_range = 40.0 "Melting temperature range (K)";
  ...
  annotation(
    Documentation(info = "<html><head></head><body><p style=\"font-size: 12px;\"><b style=\"font-family: 'DejaVu Sans Mono';\">Model Description:</b></p><p style=\"font-size: 12px;\"><span style=\"font-family: 'DejaVu Sans Mono';\">Note that this is a ficticious PCM material, not to be used for any technoeconomics.</span></p><p style=\"font-size: 12px;\">1. Phase change material with constant phasewise cp, density and thermal conductivity.</p><p style=\"font-size: 12px;\">2. Broad melting temperature between 1030 and 1070 degC</p><p style=\"font-size: 12px;\">3. Thermal conductivity is calculated based on a sharp melting front.</p><div class=\"htmlDoc\" style=\"font-family: 'DejaVu Sans Mono';\"><div class=\"htmlDoc\" style=\"font-size: 12px;\"><div><b>Properties:</b></div><div><br></div><div>Unit storage cost = 4.00 USD</div><div>T_melt = 1323.15 K or 1050 degC</div><div>T_range = 20.0 K (melts between 1040 - 1060 degC)</div><div>h_melt = 500000 J/kg (before considering the broad melt temperature)</div><div><br></div><div>Specific heat capacity:</div><div>cp_1 = 900.0 J/kgK (solid)</div><div>cp_2 = 1100.0 J/kgK (liquid)</div><div><br></div><div>Density:</div><div>rho_1 = 2600.0 kg/m3 (solid)</div><div>rho_2 = 2400.0 kg/m3 (liquid)</div><div><br></div><div>Thermal conductivity:</div><div>k_1 = 22.0 W/mK (solid)</div><div>k_2 = 18.0 W/mK (liquid)</div><div><br></div></div></div></body></html>"));
end PCM1050_Broad40K;