...
package NaCl_10K "Pure sodium chloride, sharp melting point, 10K intervals, f = 0.1 intervals"
  ...
  redeclare model State "A model which calculates state and properties"
    parameter String table_file = Modelica.Utilities.Files.loadResource("modelica://SolarTherm/Data/MaterialTables/NaCl_10K.txt");
