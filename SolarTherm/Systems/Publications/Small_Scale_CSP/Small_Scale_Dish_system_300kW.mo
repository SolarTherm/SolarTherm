...
model Small_Scale_Dish_system_300kW
  ...
  //Replaceable Models
  //**********************
  replaceable model Cycle = SolarTherm.Models.PowerBlocks.Correlation.sCO2NREL_300kWe_574C_290C;
  ...
  parameter SI.Power P_name = 300.0e3 "Nameplate rating of power block";
...
end Small_Scale_Dish_system_300kW;
