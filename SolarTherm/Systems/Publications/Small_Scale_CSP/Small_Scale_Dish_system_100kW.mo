...
model Small_Scale_Dish_system_100kW
  ...
  //Replaceable Models
  //**********************
  replaceable model Cycle = SolarTherm.Models.PowerBlocks.Correlation.sCO2NREL_100kWe_574C_290C;
  ...
  parameter SI.Power P_name = 100.0e3 "Nameplate rating of power block";
  parameter SI.Power P_gross = P_name * (1 + par_fr) / (nu_net_blk - par_fix_fr) "Power block gross rating at design point";
  parameter Real eff_PB_gross_des = 0.2939 "Design gross efficiency of PB";
...
end Small_Scale_Dish_system_100kW;
