...
model Thermocline_Group3_Reference
...
//Actually SM*10"
  ...
  SolarTherm.Models.Storage.Thermocline.Cascaded.Thermocline_Group_3 Tank(redeclare package Medium = Medium, redeclare package Fluid_Package = Fluid, redeclare package Filler_Package_A = PCM_Bot_Package,  redeclare package Filler_Package_B = Filler, redeclare package Filler_Package_C = PCM_Top_Package, N_f_A = 10, N_p_A = 5, N_f_B = 30, N_p_B = 5, N_f_C = 10, N_p_C = 5, frac_1=0.2, frac_2=0.2, T_max = T_des_high, T_min = T_des_low,d_p=0.10, ar = 4.0, eta = 0.24, U_loss_tank = 0.01,Correlation=3) annotation(
...
end Thermocline_Group3_Reference;