...
model Thermocline_Parallel_Reference
...
//Actually SM*10"
  ...
  package PCM_Top_Package = SolarTherm.Materials.PigIron_Constant;//Not PCM
  package PCM_Bot_Package = SolarTherm.Materials.PigIron_Constant;//Not PCM
...
end Thermocline_Parallel_Reference;