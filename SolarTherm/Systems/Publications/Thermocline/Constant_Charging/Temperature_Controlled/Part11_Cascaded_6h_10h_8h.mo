...
model Part11_Cascaded_6h_10h_8h
  ...
  //Do not change
  package Filler_Package_B = SolarTherm.Materials.PCM_650;
  ...
  parameter SI.Length t_e = 1.0e-3 "Encapsulation thickness for Tank_A and Tank_C is 1mm";
  //Design Parameters
  //Fixed
  ...
  //COntrol
  SolarTherm.Models.Storage.Thermocline.Series.Thermocline_Spheres_SGroup3_Final thermocline_Tank(redeclare package Medium = Medium, redeclare package Fluid_Package = Fluid_Package, redeclare package Filler_Package_A = Filler_Package_A, redeclare package Filler_Package_B = Filler_Package_B, redeclare package Filler_Package_C = Filler_Package_C, frac_1 = 0.4, frac_2 = 0.2, N_f_A = 40, N_f_B = 20, N_f_C = 40, N_p_A = N_p, T_max = T_max, T_min = T_min, E_max = E_max, ar_A = ar, eta_A = eta, d_p_A = d_p, U_loss_tank_A = U_loss_tank, Correlation = Correlation, redeclare package Encapsulation_Package_A = Encapsulation_Package, redeclare package Encapsulation_Package_B = Encapsulation_Package, redeclare package Encapsulation_Package_C = Encapsulation_Package, t_e_A = t_e, t_e_B = t_e, t_e_C = t_e) annotation(
