within SolarTherm.Systems.Publications.Thermocline.Constant_Charging.Temperature_Controlled.Grid_Convergence_Study;

model Part1_MgO_Coarse
  ...
  //Tanks
  parameter Integer N_f = 64 "Number of fluid CVs in main tank";
  //Study this
