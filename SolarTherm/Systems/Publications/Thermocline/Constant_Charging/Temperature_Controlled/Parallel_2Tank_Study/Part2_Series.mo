...
model Part2_Series
  ...
  parameter Real ar = 2.0 * (1.0 / 2.0) "Tank aspect ratio";
  //Derived
...
equation
  ...
  W = Utilities.Thermocline.Degradation_Width_2(thermocline_Tank.ZDH,thermocline_Tank.T_f_degC,0.05,0.95,T_min-273.15,T_max-273.15);
