...
package CFD_Comparison_Study
  ...
  import SI = Modelica.SIunits;
    ...
    package Filler_Package = SolarTherm.Media.Materials.Al2O3_Constant;//MgO_Constant;  //Can investigate different filler
    //Design Parameters
    //Fixed
  ...
  */
  ...
  import SI = Modelica.SIunits;
    ...
    package Medium = SolarTherm.Media.Sodium.Sodium_pT; //Do not change
    package Fluid_Package = SolarTherm.Media.Materials.Sodium; //Do not change
    package Filler_Package = SolarTherm.Media.Materials.CaO_Constant;//MgO_Constant;  //Can investigate different filler
    //Design Parameters
    //Fixed
    parameter Integer Correlation = 3 "Conservative";
    parameter SI.Temperature T_min = 520 + 273.15 "Minimum temperature";
