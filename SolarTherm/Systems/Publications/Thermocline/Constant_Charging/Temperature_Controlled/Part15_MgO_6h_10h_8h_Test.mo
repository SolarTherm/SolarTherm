...
model Part15_MgO_6h_10h_8h_Test
  ...
  //package Filler_Package_C = SolarTherm.Materials.MgO_Constant;
  //Design Parameters
  //Fixed
  ...
  parameter Real ar_A = 2.0/3 "Tank aspect ratio";
  parameter Real ar_B = 2.0/3 "Tank aspect ratio";
  parameter Real ar_C = 2.0/3 "Tank aspect ratio";
  //Derived
  ...
  //COntrol
  SolarTherm.Models.Storage.Thermocline.Series.Thermocline_Spheres_SGroup3_Final thermocline_Tank(redeclare package Medium = Medium, redeclare package Fluid_Package = Fluid_Package, redeclare package Filler_Package_A = Filler_Package, redeclare package Filler_Package_B = Filler_Package, redeclare package Filler_Package_C = Filler_Package, frac_1 = 1.0/3.0, frac_2 = 1.0/3.0, N_f_A = 33, N_f_B = 33, N_f_C = 33, N_p_A = N_p, T_max = T_max, T_min = T_min, E_max = E_max, ar_A = ar_A,ar_B = ar_B, ar_C = ar_C, eta_A = eta, d_p_A = d_p, U_loss_tank_A = U_loss_tank, Correlation = Correlation) annotation(
