...
model Part11_Parallel_6h_10h_8h
  ...
  package Filler_Package = SolarTherm.Materials.CaO_Constant;
  //Design Parameters
  //Fixed
  ...
  parameter Integer N_f = 100 "Number of fluid CVs in main tank"; //Study this
  parameter Integer N_p = 10 "Number of filler CVs  in main tank"; //Study this
  ...
  //COntrol
    ...
    SolarTherm.Models.Storage.Thermocline.Parallel.Thermocline_Spheres_Parallel_A2 thermocline_Tank(redeclare package Medium = Medium, redeclare package Fluid_Package = Fluid_Package, redeclare package Filler_Package_A = Filler_Package, redeclare package Filler_Package_B = Filler_Package, Correlation = 3, E_max = E_max, N_f_A = 50, N_p_A = 5, N_f_B = 50, N_p_B = 5, T_max = T_max, T_min = T_min, U_loss_tank = U_loss_tank, ar_A = ar, d_p_A = d_p, eta_A = eta, frac_1 = 0.5, T_bot_high = T_Recv_max - 5, T_top_low = T_PB_min + 5) annotation(
