...
model Part2_MgO_6h_10h_8h
  ...
  //Design Parameters
  //Fixed
  parameter Integer Correlation = 1 "3 --> if use sodium, 1 --> if use air";
  ...
  parameter SI.Energy E_max = 8.64e12;//t_storage * 3600 * (P_name / eff_PB) "Storage capacity (J), t_discharge(s), 100MWe, 50% PB efficiency";
  ...
  parameter SI.Time t_standby = 0;//max(0,24.0 * 3600.0 - t_charge - t_discharge) "Standby period between discharge and charge";
