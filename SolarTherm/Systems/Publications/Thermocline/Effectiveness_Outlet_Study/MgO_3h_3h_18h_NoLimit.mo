...
model MgO_3h_3h_18h_NoLimit
  ...
  parameter SI.Time t_charge = 3.0 * 3600.0 "Charging period";
  ...
  parameter SI.Time t_discharge = 3.0 * 3600.0 "Discharging period";
