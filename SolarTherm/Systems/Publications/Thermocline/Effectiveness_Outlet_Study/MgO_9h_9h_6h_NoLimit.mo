...
model MgO_9h_9h_6h_NoLimit
  ...
  parameter SI.Time t_charge = 9.0 * 3600.0 "Charging period";
  ...
  parameter SI.Time t_discharge = 9.0 * 3600.0 "Discharging period";
