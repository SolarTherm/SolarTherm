...
model Three_Tank_Series_VD
  ...
  Modelica.Fluid.Sources.Boundary_pT Recv_outlet(redeclare package Medium = Medium, T = T_max, nPorts = 1, p = 101325) annotation(
    Placement(visible = true, transformation(origin = {-114, 72}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
  Modelica.Fluid.Sources.Boundary_pT PB_outlet(redeclare package Medium = Medium, T = T_min, nPorts = 1, p = 101325) annotation(
    Placement(visible = true, transformation(origin = {120, -80}, extent = {{16, -16}, {-16, 16}}, rotation = 0)));
  //Storage Model
  ...
  SolarTherm.Models.Fluid.Sources.FluidSink Recv_Sink(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {-124, -80}, extent = {{26, -26}, {-26, 26}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression Tamb(y = 298.15) annotation(
    Placement(visible = true, transformation(origin = {-48, 0}, extent = {{-12, -18}, {12, 18}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression m_flow_Recv(y = m_Recv_signal) annotation(
    Placement(visible = true, transformation(origin = {-113, 5}, extent = {{-19, -17}, {19, 17}}, rotation = 0)));
  ...
  SolarTherm.Models.Fluid.Valves.PBS_TeeJunction thermocline_Splitter1(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {0, 61.5547}, extent = {{-16, 0}, {16, 22.4453}}, rotation = 0)));
  SolarTherm.Models.Fluid.Valves.PBS_TeeJunction thermocline_Splitter2(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {-6.66134e-16, -60.7198}, extent = {{-20, 0}, {20, 18.7225}}, rotation = 180)));
  ...
  SolarTherm.Models.Fluid.Sources.FluidSink PB_Sink(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {122, 74}, extent = {{-24, -24}, {24, 24}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression p_amb(y = 101325) annotation(
    Placement(visible = true, transformation(origin = {47, 0}, extent = {{13, -16}, {-13, 16}}, rotation = 0)));
...
//Connectors
  ...
  connect(thermocline_Splitter1.fluid_c, mass_loop_breaker.port_a) annotation(
    Line(points = {{0, 68}, {0, 64}}, color = {0, 127, 255}));
  annotation(
    experiment(StopTime = 864000, StartTime = 0, Tolerance = 1e-3, Interval = 60),
    Diagram(coordinateSystem(extent = {{-150, -100}, {150, 100}}, preserveAspectRatio = false), graphics = {Text(origin = {9, 95}, extent = {{-27, 5}, {5, -5}}, textString = "Splitter 1"), Text(origin = {13, -91}, extent = {{-27, 5}, {5, -5}}, textString = "Splitter 2"), Text(origin = {33, 53}, extent = {{-27, 5}, {27, -11}}, textString = "Loop Breaker (Mass)"), Text(origin = {-1, 85}, extent = {{-19, 1}, {-11, -5}}, textString = "a"), Text(origin = {31, 85}, extent = {{-19, 1}, {-11, -5}}, textString = "b"), Text(origin = {19, 73}, extent = {{-19, 1}, {-11, -5}}, textString = "c"), Text(origin = {29, -73}, extent = {{-19, 1}, {-5, -5}}, textString = "a"), Text(origin = {-1, -73}, extent = {{-25, 1}, {-5, -5}}, textString = "b"), Text(origin = {11, -61}, extent = {{-25, 1}, {-5, -5}}, textString = "c")}),
    Icon(coordinateSystem(extent = {{-150, -100}, {150, 100}}, preserveAspectRatio = false)));
end Three_Tank_Series_VD;