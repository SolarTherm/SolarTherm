...
model WindPV_HBSTES_3TMixed_SystemModel "Generic system model with WindPV input, Annular TES component and a boiler"
  ...
  parameter Real util_storage_des = 0.6386; //Utilisation determined via component-level analysis 0.5767
  parameter Real level_storage_mid = 0.4914; //Midpoint of minimum and maximum storage levels determine via component-level analysis 0.4637
