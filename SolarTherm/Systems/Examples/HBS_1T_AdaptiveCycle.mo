...
model HBS_1T_AdaptiveCycle "Hot Blast Stove TES, single tank"
  ...
  package Filler_Package = SolarTherm.Materials.Examples.Gan_Checker3_Constant;
  ...
  parameter Integer N_f = 160 "Number of vertical mesh elements";
