...
model HBS_2T_PCMTopper_AdaptiveCycle "Hot Blast Stove TES. Two tanks. A sensible storage tank coupled with a PCM1050 topper tank."
  ...
  package Filler_Package_B = SolarTherm.Materials.Examples.PCM1050_Sharp;
