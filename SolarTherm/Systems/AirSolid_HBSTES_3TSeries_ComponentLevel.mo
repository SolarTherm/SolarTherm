...
model AirSolid_HBSTES_3TSeries_ComponentLevel
  ...
  SolarTherm.Models.Fluid.Sources.FluidSink2 Heater_Sink(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {-120, -36}, extent = {{22, -22}, {-22, 22}}, rotation = 0)));
  ...
  SolarTherm.Models.Fluid.Sources.FluidSink2 Process_Sink(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {106, 44}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
//Connectors
  ...
  connect(Heater_Sink.port_a, heater_sink_pump.fluid_b) annotation(
    Line(points = {{-98, -36}, {-66, -36}}, color = {0, 127, 255}));
  connect(Process_Sink.port_a, process_sink_pump.fluid_b) annotation(
    Line(points = {{86, 44}, {54, 44}}, color = {0, 127, 255}));
  ...
  connect(mass_loop_breaker.port_b, TES.fluid_a) annotation(
    Line(points = {{0, 36}, {0, 28}, {1, 28}, {1, 22}}, color = {0, 127, 255}));
  connect(TES.fluid_b, thermocline_Splitter2.fluid_c) annotation(
    Line(points = {{1, -24}, {1, -34}, {0, -34}, {0, -42}}, color = {0, 127, 255}));
  connect(Tamb.y, TES.T_amb) annotation(
    Line(points = {{-26, -2}, {-20, -2}, {-20, -1}, {-12, -1}}, color = {0, 0, 127}));
