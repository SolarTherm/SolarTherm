...
model PBS_Surround_SCO2NREL_CurveFit_MultiTank
...
//Actually SM*10"
  ...
  //Storage Design
  //Controller Levels
  parameter Real L_recv_max = 0.907399;
  //L_4
  parameter Real L_recv_start = 0.869922;
  //L_3
  parameter Real L_PB_start = 0.153759;
  //L_2
  parameter Real L_PB_min = 0.124172;
  //L_1
  ...
  SolarTherm.Models.Storage.Thermocline.Thermocline_Table_MultiTank_Final thermocline_Regression(redeclare package Medium = Medium, redeclare package Fluid_Package = Fluid, E_max = t_storage * Q_flow_ref_blk * 3600.0, T_max = T_max, T_min = T_min, L_start = 0.0) annotation(
...
end PBS_Surround_SCO2NREL_CurveFit_MultiTank;