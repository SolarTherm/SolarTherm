...
model Part4_Thermocline_Fluid
  ...
  parameter SI.Length H_tank = thermocline_Tank.Tank_A.H_tank "Tank height m";
  parameter SI.Length D_tank = thermocline_Tank.Tank_A.D_tank "Tank diameter m";
  //Derived
  ...
  //COntrol
  SolarTherm.Models.Storage.Thermocline.Thermocline_Fluid_SingleTank_Final thermocline_Tank(redeclare package Medium = Medium, redeclare package Fluid_Package = Fluid_Package, N_f = N_f, T_max = T_max, T_min = T_min, E_max = E_max, ar = ar, U_loss_tank = U_loss_tank) annotation(
  ...
  SolarTherm.Models.Fluid.Valves.PBS_TeeJunction_LoopBreaker thermocline_Splitter2(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {0, -40.3493}, extent = {{-14, 0}, {14, 21.6507}}, rotation = 180)));
...
equation
  ...
  if abs(thermocline_Tank.Tank_A.m_flow) > (1.0e-3) then
...
//charging
    ...
    der(E_pump) = thermocline_Tank.Tank_A.W_loss_pump; //Obtain this inside
  else
    der(numer) = 0.0;
    der(E_charged) = 0.0;
    der(E_discharged) = 0.0;
...
//subtract pumping power
  ...
  thermocline_Splitter2.fluid_b.p = 101325;
  thermocline_Splitter2.fluid_a.p = 101325;
connect(thermocline_Tank.fluid_b, thermocline_Splitter2.fluid_c) annotation(
    Line(points = {{0, -32}, {0, -51}}, color = {0, 127, 255}));
connect(thermocline_Splitter2.fluid_b, pumpSimple_EqualPressure2.fluid_a) annotation(
    Line(points = {{-11, -60}, {-34, -60}, {-34, -36}, {-46, -36}}, color = {0, 127, 255}));
...
connect(pumpSimple_EqualPressure3.fluid_b, thermocline_Splitter2.fluid_a) annotation(
    Line(points = {{30, -60}, {11, -60}}, color = {0, 127, 255}));
...
connect(pumpSimple_EqualPressure.fluid_b, thermocline_Splitter1.fluid_a) annotation(
    Line(points = {{-44, 48}, {-30, 48}, {-30, 86}, {-13, 86}}, color = {0, 127, 255}));
connect(thermocline_Splitter1.fluid_b, pumpSimple_EqualPressure1.fluid_a) annotation(
    Line(points = {{13, 86}, {22, 86}, {22, 44}, {34, 44}}, color = {0, 127, 255}));
