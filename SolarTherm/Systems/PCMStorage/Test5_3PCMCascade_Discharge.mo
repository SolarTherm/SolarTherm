...
annotation (Documentation(info ="<html>
  		...
  		<p>This is an isolation test case for discharging a 3-PCM cascade storage system designed to provide a 1000 MWh<sub>th</sub> discharge capacity for a hypothetical CSP plant being investigated by ASTRI. The detail of the design and the simulation condition was described in the publication (https://doi.org/10.1016/j.renene.2019.11.115). In this cascade storage system, three PCMs with different melting points of 705<sup>o</sup>C, 635<sup>o</sup>C and 569<sup>o</sup>C are connected in series. Initially, all the three PCMs have a temperature of 750 <sup>o</sup>C. When the discharging process starts, liquid sodium at 540 <sup>o</sup>C enters the first PCM (PCM569), and flows through PCM635 and exits from PCM710. </p>
  		<img src=\"modelica://SolarTherm/Resources/Images/PCMModels/3PCMCascade_Discharge.png\"> 
  		<p> The temperatures of liquid sodium exiting the storage system were predicted by using this 1D Modelica model and a more detailed 2D numerical model. The comparison is shown in the figure below. The results estimated by both models are in very good agreement and the discrepancy is due to the ignorance of natural convection in the 1D Modelica model. </p>		
 
  		<img src=\"modelica://SolarTherm/Resources/Images/PCMModels/3PCMCascade_DischargeCurve.png\">
