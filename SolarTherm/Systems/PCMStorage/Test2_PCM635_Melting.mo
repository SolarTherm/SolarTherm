...
annotation (Documentation(revisions ="<html>
  		...
  		<p>This is an isolation test case for melting PCM635 (a phase change material with melting temperature of 635 deg. C) contained in the shell side. Initially, the PCM is at a temperature of 540 deg. C and liquid sodium enters the tube at 750 deg.C with a mass flow rate of 0.075 kg/s. </p>
  		</html>"));  
