...
model HBSTES_CompLevel_Adaptive_1T_1100C "This component analysis allows a variable cycle length where charging and discharging follow immediately after each other assuming the system temperate constraints have not been violated. Tank heights are fixed to 35m for all cases."
...
end HBSTES_CompLevel_Adaptive_1T_1100C;