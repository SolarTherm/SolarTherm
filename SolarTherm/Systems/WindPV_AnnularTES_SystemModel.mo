...
model WindPV_AnnularTES_SystemModel "Generic system model with WindPV input, Annular TES component and a boiler"
  ...
  parameter Real util_storage_des = 0.5767; //Utilisation determined via component-level analysis
  parameter Real level_storage_mid = 0.4637; //Midpoint of minimum and maximum storage levels determine via component-level analysis
