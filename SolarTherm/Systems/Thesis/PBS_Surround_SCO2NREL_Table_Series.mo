...
model PBS_Surround_SCO2NREL_Table_Series
  ...
  //Packed-bed storage, three-tank series configuration, surround field with external-cylindrical receiver, SCO2 power block
...
//Actually SM*10"
  ...
  parameter String storage_file = stor_file_naming("modelica://SolarTherm/Data/Storage/Storage_Table_Series42_252_", t_storage);//Modelica.Utilities.Files.loadResource("modelica://SolarTherm/Data/Storage/Storage_Table_Mixed42_252_10h.motab");
  ...
  //Power Block
  SolarTherm.Models.PowerBlocks.PBS_PowerBlockModel_sCO2NREL_100MWe_720C_500C powerBlock(redeclare package Medium = Medium, redeclare model Cooling = SolarTherm.Models.PowerBlocks.Cooling.NoCooling, capped = true, Q_flow_ref = Q_flow_ref_blk, T_out_ref = T_PB_out_des, W_base = 0.0055 * P_gross_des, m_flow_ref = m_flow_blk_des, nu_net = eff_net_des) annotation(
