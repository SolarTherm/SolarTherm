...
model SB_Polar_StirlingSES
  ...
  // Field
  parameter String opt_file_prefix = "modelica://SolarTherm/Data/Optics/SodiumBoiler/polar/1MWe/3460c%/1073K/1000kWpm2/" + SM_guess + "dSM/" + "isp_designpt/" + "100%HT_";
  parameter Solar_angles angles = Solar_angles.dec_hra "Angles used in the lookup table file";
  parameter Real SM_guess = 1.8 "Solar multiple";
  parameter String SM_string = String(2*round(SM_guess*5)) "Solar Multiple rounded to the nearest 0.2, multiplied by 10 and converted to string";
