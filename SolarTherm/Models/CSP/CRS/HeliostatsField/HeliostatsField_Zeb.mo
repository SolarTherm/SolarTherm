...
model HeliostatsField_Zeb
  extends Interfaces.Models.Heliostats;
  parameter String fileA;
  parameter String fileB;
  ...
  replaceable model Optical = SolarTherm.Models.CSP.CRS.HeliostatsField.Optical.TwoTable_Full(fileA=fileA,fileB=fileB,weight=weight)
  constrainedby
