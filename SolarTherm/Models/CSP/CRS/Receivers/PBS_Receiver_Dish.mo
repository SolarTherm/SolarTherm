...
model PBS_Receiver_Dish
  ...
  Modelica.Blocks.Interfaces.RealInput Q_defocus "Required defocus heat rate" annotation (Placement(
        ...
        origin={98, -10},extent={{-6,-6},{6,6}},
        rotation=180)));
    
  Modelica.Blocks.Interfaces.RealOutput Q_rcv_raw annotation(
    Placement(visible = true, transformation(origin = {108, 2}, extent = {{-18, -18}, {18, 18}}, rotation = 0), iconTransformation(origin = {101, 21}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));

  Modelica.Blocks.Interfaces.BooleanInput defocus annotation (Placement(
        visible = true,transformation(extent = {{-126, -88}, {-86, -48}}, rotation = 0),iconTransformation(extent = {{-110, -30}, {-86, -6}}, rotation = 0)));
