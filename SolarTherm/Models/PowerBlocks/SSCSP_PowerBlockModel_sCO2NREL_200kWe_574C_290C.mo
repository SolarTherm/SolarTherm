...
model SSCSP_PowerBlockModel_sCO2NREL_200kWe_574C_290C
  extends Interfaces.Models.PowerBlock;

  replaceable model Cycle =
     SolarTherm.Models.PowerBlocks.Correlation.sCO2NREL_200kWe_574C_290C constrainedby
  ...
  parameter SI.HeatFlowRate W_des=200.0e3/nu_net "Design turbine gross output" annotation (Dialog(group="Design"));
  ...
  parameter SI.HeatFlowRate Q_flow_ref=727313.6 "Design thermal power" annotation (Dialog(group="Design"));
  parameter SI.MassFlowRate m_flow_ref=1.690767 "Design HTF flow rate";
  ...
  Boolean logic;
  parameter Real C_PB_total = 1156751.0 "Total PB cost obtained in SAM SSC";
...
end SSCSP_PowerBlockModel_sCO2NREL_200kWe_574C_290C;