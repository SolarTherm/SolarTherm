...
model PBS_PowerBlockModel_sCO2NREL_100MWe_710C_500C
  extends Interfaces.Models.PowerBlock;

  replaceable model Cycle =
     SolarTherm.Models.PowerBlocks.Correlation.sCO2NREL_100MWe_710C_500C constrainedby
  ...
  parameter SI.Temperature T_in_ref=from_degC(710) "HTF inlet temperature (design)" annotation (Dialog(group="Design"));
  ...
  parameter SI.MassFlowRate m_flow_ref=882.358 "Design HTF flow rate";
  ...
  Boolean logic;
  parameter Real C_PB_total = 145719990.0 "Total PB Cost (USD)";
...
end PBS_PowerBlockModel_sCO2NREL_100MWe_710C_500C;