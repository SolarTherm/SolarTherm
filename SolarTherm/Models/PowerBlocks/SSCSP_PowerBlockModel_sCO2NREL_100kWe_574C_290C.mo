...
model SSCSP_PowerBlockModel_sCO2NREL_100kWe_574C_290C
  extends Interfaces.Models.PowerBlock;

  replaceable model Cycle =
     SolarTherm.Models.PowerBlocks.Correlation.sCO2NREL_100kWe_574C_290C constrainedby
  ...
  parameter SI.HeatFlowRate W_des=100.0e3/nu_net "Design turbine gross output" annotation (Dialog(group="Design"));
  ...
  parameter SI.HeatFlowRate Q_flow_ref=363656.8 "Design thermal power" annotation (Dialog(group="Design"));
  parameter SI.MassFlowRate m_flow_ref=0.845383 "Design HTF flow rate";
  ...
  Boolean logic;
  parameter Real C_PB_total = 671699.0 "Total PB cost obtained in SAM SSC";
...
end SSCSP_PowerBlockModel_sCO2NREL_100kWe_574C_290C;