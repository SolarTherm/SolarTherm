...
model PBS_PowerBlockModel_sCO2NREL_100MWe_700C_510C
  extends Interfaces.Models.PowerBlock;

  replaceable model Cycle =
     SolarTherm.Models.PowerBlocks.Correlation.sCO2NREL_100MWe_700C_510C constrainedby
  ...
  parameter SI.HeatFlowRate Q_flow_ref=229.844e6 "Design thermal power" annotation (Dialog(group="Design"));
...
end PBS_PowerBlockModel_sCO2NREL_100MWe_700C_510C;