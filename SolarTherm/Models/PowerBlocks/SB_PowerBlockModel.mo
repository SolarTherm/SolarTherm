...
model SB_PowerBlockModel
  ...
  parameter SI.Temperature T_in_ref=from_degC(800) "HTF inlet temperature (design)" annotation (Dialog(group="Design"));
  parameter SI.Temperature T_out_ref=from_degC(800) "HTF outlet temperature (design)"
...
equation
  ...
  State_in.p = State_out.p;
  
  fluid_a.p = State_in.p;
  fluid_b.p = State_out.p;
