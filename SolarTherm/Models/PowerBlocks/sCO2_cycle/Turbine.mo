...
initial algorithm
	...
	rho_out_des := SolarTherm.Utilities.CoolProp.stprops("D","P",p_out_des,"H",h_out_des,fluid);
...
equation
	...
	h_out_isen = SolarTherm.Utilities.CoolProp.stprops("H","P",p_out,"S",s_in,fluid);
	h_out = h_in - (h_in - h_out_isen) * eta_turb;
	port_b.h_outflow = h_out;
	rho_out = SolarTherm.Utilities.CoolProp.stprops("D","P",p_in,"H",h_out,fluid);
