...
model sCO2NREL_100MWe_720C_500C "SCO2 cycle based on regression of NREL PB, Sodium HTF"
    ...
    parameter Real eta_w_des = 0.476106 * (0.51/0.476106) "Design Cycle efficiency";
    parameter Real eta_gross_des = 0.451793 * (0.51/0.476106) "Design gross efficiency, product of eta_q and eta_w";
...
equation
    ...
    k_w = ( b_0 + b_1*(T_ND) + b_2*(T_ND^2) + b_3*(T_amb_ND) + b_4*(T_amb_ND^2) + b_5*(T_amb_ND^3) + b_6*(load) + b_7*(load^2) ) * (0.51/0.476106);
