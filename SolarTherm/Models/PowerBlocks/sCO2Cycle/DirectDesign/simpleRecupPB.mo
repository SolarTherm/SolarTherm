within SolarTherm.Models.PowerBlocks.sCO2Cycle.DirectDesign;
	model simpleRecupPB
		...
		parameter SI.ThermodynamicTemperature T_high = from_degC(800) "inlet temperature of the turbine";
		parameter SI.ThermodynamicTemperature T_amb = from_degC(40) "ambient temperature";
