...
model HotPumpControl3
  ...
  parameter SI.Time delay=from_hour(0.5) "Power block start-up time";
...
equation
  ...
  connect(startUpLogic.y, m_flow)
    annotation (Line(points={{25.2,0},{112,0}},         color={0,0,127}));
  connect(startUpLogic.u, logic.y) annotation (Line(points={{5.2,0},{-21.04,0}},
                      color={255,0,255}));
end HotPumpControl3;
