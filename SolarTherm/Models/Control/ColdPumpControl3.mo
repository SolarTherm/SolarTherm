...
model ColdPumpControl3
  ...
  ColdTankLogic4 coldTankLogic4_1(DNI_min=DNI_min)
...
equation
  ...
  connect(DNI_mea, coldTankLogic4_1.DNI_ref)
    annotation (Line(points={{-110,-60},{-76,-60}}, color={0,0,127}));
  connect(hotTankLogic.y, and1.u1) annotation (Line(points={{-53.2,0},{-44,0},{
          -44,-12},{-36,-12}}, color={255,0,255}));
  connect(and1.u2, coldTankLogic4_1.y) annotation (Line(points={{-36,-20},{-46,
          -20},{-46,-60},{-55.2,-60}}, color={255,0,255}));
  connect(and1.y, switch.u2) annotation (Line(points={{-13,-12},{-6,-12},{-6,0},
          {52.8,0}}, color={255,0,255}));
end ColdPumpControl3;
