...
model WindPV_RadTESControl //now outputs the demand m_flow_PB_dem if able, now increases m_flow_PB if the storage outlet is below the ideadl temperature
  ...
  Modelica.Blocks.Interfaces.RealInput T_top_tank "Temperature of the top of HTF in storage"
    annotation (Placement(visible = true, transformation(extent = {{-124, -4}, {-84, 36}}, rotation = 0), iconTransformation(extent = {{-124, -10}, {-84, 30}}, rotation = 0)));
    
  Modelica.Blocks.Interfaces.RealOutput m_flow_PB(start=1.0e-8) "Power block mass flow?" annotation (Placement(visible = true, transformation(extent = {{90, -20}, {130, 20}}, rotation = 0), iconTransformation(extent = {{90, 6}, {130, 46}}, rotation = 0))) ;
  
  
  Modelica.Blocks.Interfaces.BooleanOutput heater_on(start=true) "can the heater be on?" annotation (Placement(visible = true, transformation(extent = {{90, -20}, {130, 20}}, rotation = 0), iconTransformation(extent = {{90, -60}, {130, -20}}, rotation = 0))) ;
