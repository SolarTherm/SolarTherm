...
block PID_AW_reset3 "PI-with anti-windup and reset"
  ...
  Modelica.Blocks.Interfaces.RealInput Q_input annotation(
    Placement(visible = true, transformation(origin = {54, 120}, extent = {{-20, -20}, {20, 20}}, rotation = -90), iconTransformation(origin = {-88, 120}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealInput eta_rec_in annotation(
    Placement(visible = true, transformation(origin = {92, 120}, extent = {{-20, -20}, {20, 20}}, rotation = -90), iconTransformation(origin = {94, 120}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  SolarTherm.Models.Control.limitier_v2 Limitier_v2(eta_rec_th_des=eta_rec_th_des,m_flow_des=m_flow_des,Q_in_rcv=Q_in_rcv,m_flow_max=uMax) annotation(
...
equation
  ...
  connect(Q_input, Limitier_v2.Q_input) annotation(
    Line(points = {{54, 120}, {54, 120}, {54, 22}, {70, 22}, {70, 12}, {70, 12}}, color = {0, 0, 127}));
  connect(eta_rec_in, Limitier_v2.eta_rec_in) annotation(
    Line(points = {{92, 120}, {92, 120}, {92, 22}, {76, 22}, {76, 12}, {74, 12}}, color = {0, 0, 127}));
  connect(Add.y, Limitier_v2.u) annotation(
    Line(points = {{36, 0}, {60, 0}, {60, 0}, {60, 0}}, color = {0, 0, 127}));
  connect(Limitier_v2.y, y) annotation(
    Line(points = {{84, 0}, {104, 0}, {104, 0}, {110, 0}}, color = {0, 0, 127}));
  annotation (defaultComponentName="PID",
    Icon(
        coordinateSystem(preserveAspectRatio=false,
            initialScale=0.1),
            graphics={Line(points = {{-80, 78}, {-80, -90}}, color = {192, 192, 192}), Polygon(lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid, points = {{-80, 90}, {-88, 68}, {-72, 68}, {-80, 90}}), Line(points = {{-90, -80}, {82, -80}}, color = {192, 192, 192}), Polygon(lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid, points = {{90, -80}, {68, -72}, {68, -88}, {90, -80}}), Line(points = {{-80, -80}, {-80, -20}, {60, 80}}, color = {0, 0, 127}), Text(lineColor = {192, 192, 192}, extent = {{-20, -60}, {80, -20}}, textString = "PID"), Text(extent = {{-150, -150}, {150, -110}}, textString = "Ti=%Ti")}),
