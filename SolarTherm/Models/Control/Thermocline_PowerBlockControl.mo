...
model Thermocline_PowerBlockControl
  ...
  Modelica.Blocks.Interfaces.RealInput Level "Level of the Storage"
    annotation (Placement(visible = true, transformation(extent = {{-126, -20}, {-86, 20}}, rotation = 0), iconTransformation(extent = {{-126, 48}, {-86, 88}}, rotation = 0)));
