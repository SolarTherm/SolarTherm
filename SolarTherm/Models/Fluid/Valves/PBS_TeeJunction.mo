...
model PBS_TeeJunction
  ...
  Modelica.Fluid.Interfaces.FluidPort_a fluid_c(redeclare package Medium =
        ...
        iconTransformation(origin = {0, -8}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_a fluid_a(redeclare package Medium =
        ...
        iconTransformation(origin = {-80, 72}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,0},
            {100,100}})),              Icon(coordinateSystem( preserveAspectRatio = false, initialScale = 0.1), graphics = {Line(origin = {-40.0259, 72.013}, points = {{-40, 0}, {40, 0}, {120, 0}}, thickness = 1), Line(origin = {0, 32}, points = {{0, 40}, {0, -20}, {0, -40}}, thickness = 1), Polygon(origin = {40, 72}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, points = {{-10, 10}, {-10, -10}, {10, 0}, {-10, 10}, {-10, 10}}), Polygon(origin = {-40, 72}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, points = {{-10, 10}, {-10, -10}, {10, 0}, {-10, 10}, {-10, 10}}), Polygon(origin = {0, 35}, fillColor = {124, 124, 124}, fillPattern = FillPattern.Solid, points = {{-8, 7}, {8, 7}, {0, -7}, {-8, 7}, {-8, 7}}), Polygon(origin = {0, 51}, rotation = 180, fillColor = {124, 124, 124}, fillPattern = FillPattern.Solid, points = {{-8, 7}, {8, 7}, {0, -7}, {-8, 7}, {-8, 7}}), Line(origin = {0, 51.2254}, points = {{-12, -34}, {12, -34}, {12, 8}, {60, 8}, {60, 34}, {-60, 34}, {-60, 8}, {-12, 8}, {-12, -34}, {-12, -34}})}),
