...
model PBS_TeeJunction_Valve
  ...
  Modelica.Fluid.Interfaces.FluidPort_b fluid_b(redeclare package Medium =
        ...
        iconTransformation(origin = {80, 80}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  Modelica.Blocks.Interfaces.BooleanInput open_b annotation(
    Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {24, 100}, extent = {{-10, -10}, {10, 10}}, rotation = -90))); 
...
equation
  ...
  if open_b == true then //fluid_b is open
