...
model HX_designonly
  ...
  //Design Parameters
  parameter SI.HeatFlowRate Q_d_des = 543203279.460279 "Design Heat Flow Rate";
  ...
  parameter FI.EnergyPrice_kWh c_e = 0.073 /*0.13 / 0.9175*/ "Power cost";
  parameter Real r = 0.05 "Real interest rate";
  parameter Real H_y(unit = "h") = 5600 "Operating hours";
