...
model IFBHX_Fe2O3_H2_Simple
  extends SolarTherm.Icons.Indirect_FBHX;
  ...
  Modelica.Fluid.Interfaces.FluidPort_a fluid_HA_in annotation(
    Placement(visible = true, transformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0), iconTransformation(origin = {-82, 12}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b fluid_HA_out annotation(
    Placement(visible = true, transformation(extent = {{-110, -80}, {-90, -60}}, rotation = 0), iconTransformation(origin = {82, -60}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_a fluid_C_in annotation(
    Placement(visible = true, transformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0), iconTransformation(origin = {-82, -60}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b fluid_C_out annotation(
    Placement(visible = true, transformation(extent = {{-110, -80}, {-90, -60}}, rotation = 0), iconTransformation(origin = {82, 12}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  //Design Parameters
...
//Q_flow[i] = (UA/N)*(T_H_avg[i]-T_C_avg[i]);
  ...
  */
  annotation(
    ...
    Icon(graphics = {Text(origin = {20, 242}, lineColor = {0, 0, 255}, extent = {{-149, -114}, {103, -138}}, textString = "%name"), Text(origin = {-89, -66}, extent = {{-17, 28}, {9, 14}}, textString = "H2 in"), Text(origin = {-91, 10}, extent = {{-17, 28}, {25, 4}}, textString = "Fe2O3 in"), Text(origin = {83, -62}, extent = {{-19, 30}, {25, 4}}, textString = "Fe2O3 out"), Text(origin = {97, 6}, extent = {{-21, 28}, {9, 14}}, textString = "H2 out")}, coordinateSystem(extent = {{-110, -100}, {110, 100}}, initialScale = 0.1)));
end IFBHX_Fe2O3_H2_Simple;