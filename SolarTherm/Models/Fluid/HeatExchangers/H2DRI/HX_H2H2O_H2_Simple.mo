...
model HX_H2H2O_H2_Simple
  ...
  Modelica.Fluid.Interfaces.FluidPort_a fluid_HA_in annotation(
    Placement(visible = true, transformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0), iconTransformation(origin = {-104, 14}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_a fluid_HB_in annotation(
    Placement(visible = true, transformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0), iconTransformation(origin = {-104, 34}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b fluid_HA_out annotation(
    Placement(visible = true, transformation(extent = {{-110, -80}, {-90, -60}}, rotation = 0), iconTransformation(origin = {104, 14}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b fluid_HB_out annotation(
    Placement(visible = true, transformation(extent = {{-110, -80}, {-90, -60}}, rotation = 0), iconTransformation(origin = {104, 34}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_a fluid_C_in annotation(
    Placement(visible = true, transformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0), iconTransformation(origin = {104, -22}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b fluid_C_out annotation(
    Placement(visible = true, transformation(extent = {{-110, -80}, {-90, -60}}, rotation = 0), iconTransformation(origin = {-104, -24}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  //Design Parameters
  ...
  parameter SI.Temperature T_C_in_des = 55.0 + 273.15 "HX Inlet Cold Temperature (K)";
  ...
  parameter SI.MassFlowRate m_flow_C_des = 0.216 "Mass flow rate of cold H2O gas (kg/s)";
  parameter Real eff_des = 0.95 "Design Effectiveness of HX";
  ...
  SI.SpecificHeatCapacity cp_HA "Instantaneous approximate specific heat capacity of hot hydrogen";
  SI.SpecificHeatCapacity cp_HB "Instantaneous approximate specific heat capacity of hot hydrogen";
  SI.SpecificHeatCapacity cp_C "Instantaneous approximate specific heat capacity of cold hydrogen";
  ...
  //Component cost
  //Based on Seider plate-and-frame,  USD_2022
  ...
  parameter Real C_component = div(A_approx,1393.6)*771657.24 + 13597.45*((10.764*rem(A_approx,1393.6))^0.42) "Total component cost (USD_2022)";
...
algorithm
  if (m_flow_HA+m_flow_HB)>1.0e-9 and m_flow_C>1.0e-9 then //flowing
...
//Specific heat capacities
  cp_HA = (Modelica.Media.IdealGases.SingleGases.H2.specificEnthalpy_pT(p_HA, T_H_in) - Modelica.Media.IdealGases.SingleGases.H2.specificEnthalpy_pT(p_HA, T_C_in)) / (T_H_in - T_C_in);
  cp_HB = (Modelica.Media.Water.WaterIF97_pT.specificEnthalpy_pT(p_HB, T_H_in) - Modelica.Media.Water.WaterIF97_pT.specificEnthalpy_pT(p_HB, T_C_in)) / (T_H_in - T_C_in);
  cp_C = cp_HA;
...
//Dont forget the outlet enthalpies
  ...
  T_C_in = Modelica.Media.IdealGases.SingleGases.H2.temperature_ph(p_C,h_C_in);
  ...
  T_C_out = Modelica.Media.IdealGases.SingleGases.H2.temperature_ph(p_C,h_C_out);
...
//Q_flow[i] = (UA/N)*(T_H_avg[i]-T_C_avg[i]);
  ...
  */
  annotation(
    ...
    Icon(graphics = {Text(origin = {22, 60}, lineColor = {0, 0, 255}, extent = {{-149, -114}, {103, -138}}, textString = "%name"), Rectangle(origin = {0, 23}, fillColor = {170, 0, 0}, fillPattern = FillPattern.Sphere, extent = {{-60, 23}, {62, -23}}), Rectangle(origin = {0, -23}, fillColor = {0, 0, 127}, fillPattern = FillPattern.Sphere, extent = {{-60, 23}, {62, -23}}), Line(origin = {-83.539, 34.461}, points = {{-16, 0}, {24, 0}}), Line(origin = {-84, 13.539}, points = {{-16, 0.460992}, {24, 0.460992}}), Line(origin = {-84, -24}, points = {{-16, 0}, {24, 0}}), Line(origin = {85, 34}, points = {{-23, 0}, {15, 0}}), Line(origin = {85, 14}, points = {{-23, 0}, {15, 0}}), Line(origin = {85, -22}, points = {{-23, 0}, {15, 0}}), Line(origin = {3, 24}, points = {{-37, -2}, {33, -2}}, color = {255, 255, 255}, thickness = 1, arrow = {Arrow.None, Arrow.Open}, arrowSize = 10), Line(origin = {72.15, -21.18}, points = {{-37, -2}, {-107, -2}}, color = {255, 255, 255}, thickness = 1, arrow = {Arrow.None, Arrow.Open}, arrowSize = 10), Text(origin = {89, -20}, extent = {{-23, 34}, {9, 14}}, textString = "H2"), Text(origin = {83, 24}, extent = {{-17, 28}, {13, 10}}, textString = "H2O"),  Text(origin = {85, -50}, extent = {{-17, 28}, {11, 8}}, textString = "H2"), Text(origin = {-73, -20}, extent = {{-23, 34}, {9, 14}}, textString = "H2"), Text(origin = {-79, 24}, extent = {{-17, 28}, {13, 10}}, textString = "H2O"), Text(origin = {-77, -52}, extent = {{-17, 28}, {11, 8}}, textString = "H2")}, coordinateSystem(extent = {{-110, -100}, {110, 100}}, initialScale = 0.1)));
end HX_H2H2O_H2_Simple;