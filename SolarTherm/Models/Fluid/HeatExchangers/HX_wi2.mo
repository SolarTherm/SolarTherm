...
//Sodium properties
  ...
  //state_min_F = Medium1.setState_pTX(p_Na1, 520+273.15);
...
//Problem
  ...
  port_a_out.h_outflow = if not HF_on then h_Na_in else h_Na_in - Q / max(1e-3,m_flow_Na);
