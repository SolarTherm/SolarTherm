...
annotation(
    Diagram(graphics = {Rectangle(extent = {{-80, 40}, {80, -40}}), Line(origin = {-89, 0}, points = {{-9, 0}, {9, 0}, {9, 0}}), Line(origin = {90, 0}, points = {{-10, 0}, {10, 0}, {10, 0}}), Line(origin = {-10, 0}, points = {{10, 40}, {-10, -40}, {-10, -40}}), Line(origin = {10, 0}, points = {{10, 40}, {-10, -40}, {-10, -40}}), Text(origin = {-30, 0}, extent = {{-32, 16}, {32, -16}}, textString = "P"), Text(origin = {30, 0}, extent = {{-32, 16}, {32, -16}}, textString = "P")}, coordinateSystem(initialScale = 0.1)),
    Icon(graphics = {Line(origin = {-10, 0}, points = {{10, 20}, {-10, -20}, {-10, -20}}), Line(origin = {10, 0}, points = {{10, 20}, {-10, -20}, {-10, -20}}), Text(origin = {-21, 11}, extent = {{-11, 15}, {11, -11}}, textString = "p"), Rectangle(extent = {{-30, 20}, {30, -20}}), Text(origin = {21, -9}, extent = {{-11, 15}, {11, -11}}, textString = "p"), Line(origin = {-45, 0}, points = {{-15, 0}, {15, 0}, {15, 0}}), Line(origin = {45, 0}, points = {{-15, 0}, {15, 0}, {15, 0}})}, coordinateSystem(initialScale = 0.1)));
end pressure_loop_breaker;