...
model Reactor_H2DRI_Overall
  ...
  Modelica.Fluid.Interfaces.FluidPort_a fluid_H2_in(redeclare package Medium = Modelica.Media.IdealGases.SingleGases.H2) annotation (Placement(
        visible = true,transformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0), iconTransformation(origin = {-94, -20}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
        //Fluid Outlet Ports
  Modelica.Fluid.Interfaces.FluidPort_b fluid_H2_out(redeclare package Medium = Modelica.Media.IdealGases.SingleGases.H2) annotation (Placement(
        visible = true,transformation(extent = {{-110, -80}, {-90, -60}}, rotation = 0), iconTransformation(origin = {94, 68}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b fluid_H2O_out(redeclare package Medium = Modelica.Media.Water.WaterIF97_ph) annotation(
    ...
    SolarTherm.Models.Chemistry.H2DRI.Reaction_Extent_Table Extent(file=Modelica.Utilities.Files.loadResource("modelica://SolarTherm/Data/Reactions/H2DRI_3Step.motab"));
...
equation
    ...
    (H_1,G_1,S_1,K_1) = SolarTherm.Models.Chemistry.H2DRI.Step_1_Function(T_rxn,p_reactor);
    (H_2,G_2,S_2,K_2) = SolarTherm.Models.Chemistry.H2DRI.Step_2_Function(T_rxn,p_reactor);
    (H_3,G_3,S_3,K_3) = SolarTherm.Models.Chemistry.H2DRI.Step_3_Function(T_rxn,p_reactor);
    ...
    //Figure out the temperature of reactants before enthalpy of reaction
