...
model Reactor_H2DRI_Overall_Losses_IOG "H2DRI reactor for a generic iron ore composition IOG. Thermal losses and Wustite enthalpy correction are considered."
  ...
  Modelica.Fluid.Interfaces.FluidPort_b fluid_H2O_out(redeclare package Medium = Modelica.Media.Water.WaterIF97_ph) annotation(
    ...
    //Mass Flow
    SI.MassFlowRate m_flow_Ore_in "Mass of Fe2O3 flowing into the reactor (kg/s)";
    
    SI.MassFlowRate m_flow_Fe2O3_in "Mass of Fe2O3 flowing into the reactor (kg/s)";
    SI.MassFlowRate m_flow_Al2O3_in "Mass of Al2O3 flowing into the reactor (kg/s)";
    SI.MassFlowRate m_flow_SiO2_in "Mass of SiO2 flowing into the reactor (kg/s)";
    ...
    SI.SpecificEnthalpy h_H2_mix "Specific enthalpy of H2 after being mixed with Ore (J/kg)";
    SI.SpecificEnthalpy h_Ore_mix "Specific enthalpy of Ore after being mixed with H2 (J/kg)";
    SI.SpecificEnthalpy h_Ore_reactants "Specific enthalpy of Ore after being mixed with H2 (J/kg)";
...
//Q_flow_released = -1.0*(xi_1*H_1 + xi_2*H_2 + xi_3*H_3)*f_reaction; //Check this
    ...
    m_flow_H2_out*Modelica.Media.IdealGases.SingleGases.H2.specificEnthalpy_pT(p_H2_out,T_reactants) + m_flow_H2O_out*Modelica.Media.Water.IF97_Utilities.h_pT(p_H2O_out,T_reactants) + m_flow_Fe2O3_out*SolarTherm.Media.SolidParticles.Fe2O3_utilities.h_T(T_reactants) + m_flow_Fe3O4_out*SolarTherm.Media.SolidParticles.Fe3O4_utilities.h_T(T_reactants) + m_flow_FeO_out*SolarTherm.Media.SolidParticles.FeO_utilities.h_T(T_reactants) + m_flow_Fe_out*SolarTherm.Media.SolidParticles.Fe_utilities.h_T(T_reactants) + m_flow_Al2O3_in*SolarTherm.Media.SolidParticles.Al2O3_utilities.h_T(T_reactants) + m_flow_SiO2_in*SolarTherm.Media.SolidParticles.SiO2_utilities.h_T(T_reactants) - Q_flow_absorbed = m_flow_H2_out*h_H2_out + m_flow_H2O_out*h_H2O_out + m_flow_Fe2O3_out*h_Fe2O3_out + m_flow_Fe3O4_out*h_Fe3O4_out + m_flow_FeO_out*h_FeO_out + m_flow_Fe_out*h_Fe_out + m_flow_Al2O3_in*SolarTherm.Media.SolidParticles.Al2O3_utilities.h_T(T_products) + m_flow_SiO2_in*SolarTherm.Media.SolidParticles.SiO2_utilities.h_T(T_products);
    ...
    //Fluid Ports
    m_flow_Ore_in = fluid_Ore_in.m_flow;
    m_flow_Fe2O3_in = fluid_Ore_in.m_flow*(1.0-f_mass_Al2O3-f_mass_SiO2);
    m_flow_Al2O3_in = fluid_Ore_in.m_flow*f_mass_Al2O3;
    m_flow_SiO2_in = fluid_Ore_in.m_flow*f_mass_SiO2;
    ...
    fluid_Ore_in.h_outflow = inStream(fluid_Ore_in.h_outflow);
    ...
    //Check continuity
    m_flow_in_total = m_flow_H2_in + m_flow_Fe2O3_in + m_flow_Al2O3_in + m_flow_SiO2_in;
    m_flow_out_total = m_flow_H2_out + m_flow_H2O_out + m_flow_Fe_out + m_flow_FeO_out + m_flow_Fe3O4_out + m_flow_Fe2O3_out + m_flow_Al2O3_in + m_flow_SiO2_in;
