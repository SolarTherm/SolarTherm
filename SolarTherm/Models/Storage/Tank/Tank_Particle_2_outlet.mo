...
equation
  ...
  der(m)=fluid_a.m_flow+fluid_b.m_flow+fluid_b2.m_flow;
  ...
  m*der(medium.h)+der(m)*medium.h= //net gain
                  fluid_a.m_flow * inStream(fluid_a.h_outflow) +
                      fluid_b.m_flow * medium.h + fluid_b2.m_flow * medium.h -
                            Q_loss_radiation - 
