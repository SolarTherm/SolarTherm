...
extends SolarTherm.Interfaces.Models.HeatTransferFluid_3PCMs;
  ...
  Modelica.Blocks.Interfaces.RealOutput T_top_measured "Temperature at the top of the tank as an an output signal (K)"
            ...
            extent = {{40, 50}, {60, 70}}, rotation = 0), iconTransformation(origin = {-101, 15}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput T_bot_measured "Temperature at the bottom of the tank as an output signal (K)"
                                            annotation (Placement(visible = true,transformation(
            extent = {{40, -70}, {60, -50}}, rotation = 0), iconTransformation(origin = {99, 15}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput h_bot_outlet "Enthaply at the bottom of the tank as an output signal (K)"
                                            annotation (Placement(visible = true,transformation(
            extent = {{40, -70}, {60, -50}}, rotation = 0), iconTransformation(origin = {95, -19}, extent = {{-5, -5}, {5, 5}}, rotation = -90)));
  ...
  Modelica.Blocks.Interfaces.RealInput p_amb "Ambient Pressure" annotation (Placement(
          ...
          origin={56, -16},extent={{6, -6}, {-6, 6}},
          rotation=0)));
  
  SolarTherm.Models.Storage.PCMTubeInTank_Test.TubeInTank_Section2 Tank_Top(redeclare replaceable package Fluid = Fluid_Package, redeclare replaceable package Wall = Wall_Package, redeclare replaceable package Storage = PCM_Package1, L = L1, r_tube_in = r_tube_in, r_tube_out = r_tube_out, r_shell = r_shell, T_min = T_min, T_max = T_max, N_sec = N_sec1);
  SolarTherm.Models.Storage.PCMTubeInTank_Test.TubeInTank_Section2 Tank_Mid(redeclare replaceable package Fluid = Fluid_Package, redeclare replaceable package Wall = Wall_Package, redeclare replaceable package Storage = PCM_Package2, L = L2, r_tube_in = r_tube_in, r_tube_out = r_tube_out, r_shell = r_shell, T_min = T_min, T_max = T_max, N_sec = N_sec2);
  SolarTherm.Models.Storage.PCMTubeInTank_Test.TubeInTank_Section2 Tank_Bot(redeclare replaceable package Fluid = Fluid_Package, redeclare replaceable package Wall = Wall_Package, redeclare replaceable package Storage = PCM_Package3, L = L3, r_tube_in = r_tube_in, r_tube_out = r_tube_out, r_shell = r_shell, T_min = T_min, T_max = T_max, N_sec = N_sec3);
