...
model LC_ThreeTank_MixedOutlet
  ...
  parameter SI.SpecificEnthalpy h_tol = 0.10*(Tank_A.h_f_max - Tank_A.h_f_min) "enthalpy tolerance, 0.5% of maximum difference";
