...
model LC_TwoTank_HybridSplit
  ...
  Integer Active_Tank(start = 2) "Which tank is in use for charging";
...
algorithm
  ...
  when Tank_A.T_f[N_f_B] < T_top_low then
