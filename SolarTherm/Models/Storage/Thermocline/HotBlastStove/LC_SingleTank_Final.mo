...
annotation(
    Icon(graphics = {Text(origin = {-60, 31}, extent = {{-16, 7}, {6, -3}}, textString = "T_amb"), Text(origin = {-60, -10}, extent = {{-16, 10}, {8, -6}}, textString = "p_amb"), Text(origin = {-50, -77}, extent = {{-26, 5}, {28, -3}}, textString = "h_bot_outlet"), Text(origin = {66, -37}, extent = {{-18, 5}, {42, -25}}, textString = "T_bot_measured"), Text(origin = {69, 74}, extent = {{-15, 4}, {41, -20}}, textString = "T_top_measured"), Text(origin = {22, 84}, extent = {{-12, 4}, {24, -12}}, textString = "fluid_a"), Text(origin = {26, -76}, extent = {{-12, 4}, {26, -12}}, textString = "fluid_b"), Text(origin = {60, 51.5}, extent = {{-6, 2.5}, {14, -9.5}}, textString = "T_95%"), Text(origin = {54, -24.5}, extent = {{-6, 2.5}, {16, -11.5}}, textString = "T_05%"), Text(origin = {62, 33}, extent = {{-8, 3}, {12, -7}}, textString = "Level"), Text(origin = {-50, 77}, extent = {{-28, 5}, {28, -3}}, textString = "h_top_outlet"), Polygon(origin = {-31, 40}, fillColor = {195, 195, 195}, fillPattern = FillPattern.Solid, points = {{9, 28}, {53, 28}, {71, 20}, {71, -100}, {53, -108}, {9, -108}, {-9, -100}, {-9, 20}, {9, 28}}), Polygon(origin = {-30, 54}, fillColor = {195, 195, 195}, fillPattern = FillPattern.Solid, points = {{-10, 6}, {8, -2}, {52, -2}, {70, 6}, {70, -18}, {52, -26}, {8, -26}, {-10, -18}, {-10, 6}}), Polygon(origin = {-30, 10}, fillColor = {195, 195, 195}, fillPattern = FillPattern.Solid, points = {{-10, 2}, {8, -6}, {52, -6}, {70, 2}, {70, -24}, {52, -32}, {8, -32}, {-10, -24}, {-10, 2}}), Polygon(origin = {-30, -20}, fillColor = {195, 195, 195}, fillPattern = FillPattern.Solid, points = {{-10, 6}, {8, -2}, {52, -2}, {70, 6}, {70, -18}, {52, -26}, {8, -26}, {-10, -18}, {-10, 6}}), Line(origin = {-22, -8}, points = {{0, 60}, {0, -60}}), Line(origin = {22, -8}, points = {{0, 60}, {0, -60}}), Ellipse(origin = {-4, 64}, fillColor = {211, 211, 255}, fillPattern = FillPattern.Solid, extent = {{-3.5, -1.5}, {11.5, -4.5}}, endAngle = 360), Line(origin = {0, 64}, points = {{0, 4}, {0, -4}}), Ellipse(origin = {-22, 68}, fillColor = {211, 211, 255}, fillPattern = FillPattern.Solid, extent = {{-1.5, -1.5}, {13.5, -4.5}}, endAngle = 360), Ellipse(origin = {14, 68}, fillColor = {211, 211, 255}, fillPattern = FillPattern.Solid, extent = {{-5.5, -1.5}, {9.5, -4.5}}, endAngle = 360), Ellipse(origin = {-22, 60}, fillColor = {211, 211, 255}, fillPattern = FillPattern.Solid, extent = {{-1.5, -1.5}, {13.5, -4.5}}, endAngle = 360), Ellipse(origin = {14, 60}, fillColor = {211, 211, 255}, fillPattern = FillPattern.Solid, extent = {{-5.5, -1.5}, {9.5, -4.5}}, endAngle = 360), Ellipse(origin = {-32, 64}, fillColor = {211, 211, 255}, fillPattern = FillPattern.Solid, extent = {{-1.5, -1.5}, {13.5, -4.5}}, endAngle = 360), Ellipse(origin = {24, 64}, fillColor = {211, 211, 255}, fillPattern = FillPattern.Solid, extent = {{-5.5, -1.5}, {9.5, -4.5}}, endAngle = 360), Text(origin = {-1.227, 45.6}, lineColor = {0, 0, 255}, extent = {{-33.7733, -45.6}, {34.2267, -61.6}}, textString = "%name")}, coordinateSystem(initialScale = 0.1)), Documentation(revisions ="<html>
