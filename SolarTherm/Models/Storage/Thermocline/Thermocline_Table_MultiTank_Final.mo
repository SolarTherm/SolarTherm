...
model Thermocline_Table_MultiTank_Final
  extends SolarTherm.Interfaces.Models.StorageFluid_Thermocline;
  
  parameter String table_file = Modelica.Utilities.Files.loadResource("modelica://SolarTherm/Data/Storage/MultiTank.motab");
...
end Thermocline_Table_MultiTank_Final;