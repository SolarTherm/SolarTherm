...
model Thermocline_HBS_LC_SGroup3_Final
  ...
  parameter Real frac_2 = 1.0/3.0 "Fraction of storage capacity of Tank_B";
  parameter Real frac_3 = 1.0 - frac_1 - frac_2 "Fraction of storage capacity of Tank_C";
  ...
  SolarTherm.Models.Storage.Thermocline.Thermocline_HBS_LC_Section_Final Tank_A(redeclare replaceable package Fluid_Package = Fluid_Package, redeclare replaceable package Filler_Package = Filler_Package_A, Correlation = Correlation, E_max = E_max*frac_1, ar = ar_A, eta = eta_A, d_p = d_p_A, T_min = T_min, T_max = T_max, N_f = N_f_A, U_loss_top = U_loss_tank_A, U_loss_bot = U_loss_tank_A, z_offset = 0.0, eff_pump=eff_pump);
  //Initialize Tank_B (Middle)
  SolarTherm.Models.Storage.Thermocline.Thermocline_HBS_LC_Section_Final_middle Tank_B(redeclare replaceable package Fluid_Package = Fluid_Package, redeclare replaceable package Filler_Package = Filler_Package_B, Correlation = Correlation, E_max = E_max*frac_2, ar = ar_B, eta = eta_B, d_p = d_p_B, T_min = T_min, T_max = T_max, N_f = N_f_B, U_loss_top = U_loss_tank_B, U_loss_bot = U_loss_tank_B, z_offset = Tank_A.H_tank, eff_pump=eff_pump);
  //Initialize Tank_C (Top)
  SolarTherm.Models.Storage.Thermocline.Thermocline_HBS_LC_Section_Final Tank_C(redeclare replaceable package Fluid_Package = Fluid_Package, redeclare replaceable package Filler_Package = Filler_Package_C, Correlation = Correlation, E_max = E_max*frac_3, ar = ar_C, eta = eta_C, d_p = d_p_C, T_min = T_min, T_max = T_max, N_f = N_f_C, U_loss_top = U_loss_tank_C, U_loss_bot = U_loss_tank_C, z_offset = Tank_A.H_tank + Tank_B.H_tank, eff_pump=eff_pump);
