...
model Thermocline_Spheres_ModularSection_Bot_HSN_Final
...
equation
  ...
  //Top Charging Fluid Node, Ignore top heat loss
  ...
  //Top Discharge Node, Ignore top heat loss
    0.5*rho_f_avg*der(h_f[N_f]) =
    2.0*k_f[N_f-1]*k_f[N_f]*(T_f[N_f-1]-T_f[N_f])/((k_f[N_f-1]+k_f[N_f])*dz*dz)
...
end Thermocline_Spheres_ModularSection_Bot_HSN_Final;