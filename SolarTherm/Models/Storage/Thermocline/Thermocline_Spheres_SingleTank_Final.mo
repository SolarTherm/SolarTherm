...
model Thermocline_Spheres_SingleTank_Final
  ...
  Modelica.Blocks.Interfaces.RealOutput Level "Theoretical Tank Level"
                                          annotation (Placement(visible = true,transformation(
          extent = {{40, 16}, {60, 36}}, rotation = 0), iconTransformation(origin = {45, 17}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
