...
model Thermocline_Spheres_2P_MixedFlow_Strat2
  //2P = 2 tanks in parallel, MixedFlow strategy, Strategy 1: Tank A assist B in charging, Tank B assist A in discharging
...
equation
  ...
  */
  ...
  //Charging gets modified from Strat1
...
end Thermocline_Spheres_2P_MixedFlow_Strat2;