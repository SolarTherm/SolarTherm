...
model Thermocline_Section2_Cylinders
  ...
  //Correlation used
  parameter Integer Correlation = 8 "1=WakaoKaguei, 2=MelissariArgyropolus, 3=Conservative, 4=Bellan, 5=Laminar, 6=Laminar+Turbulent, 7 = Nie";
  //Design parameters
...
end Thermocline_Section2_Cylinders;