within SolarTherm.Models.Storage.Thermocline.Spheres.Parallel;

model LC_ThreeTank_MixedOutlet "TES Component of three thermocline tanks in parallel, each having spherical (lumped capacitance) filler material. Tanks are charged sequentially in order C-B-A and discharged in order A-B-C. Individual tank outlets can be mixed to result in a constant outlet temperature"
