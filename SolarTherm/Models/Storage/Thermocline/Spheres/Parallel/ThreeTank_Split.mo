...
model ThreeTank_Split "TES Component of three thermocline tanks in parallel, each having spherical filler material. Fluid flow is always split equally amongst three tanks"
