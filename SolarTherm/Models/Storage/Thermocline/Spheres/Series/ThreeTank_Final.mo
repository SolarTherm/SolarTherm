within SolarTherm.Models.Storage.Thermocline.Spheres.Series;

model ThreeTank_Final "TES Component model of three thermocline tanks in series, each with spherical filler"
