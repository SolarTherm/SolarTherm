...
model Thermocline_Fluid_SingleTank_Final
  ...
  //Initialize Tank
  SolarTherm.Models.Storage.Thermocline.Thermocline_Fluid_Section_Final Tank_A(redeclare replaceable package Fluid_Package = Fluid_Package, E_max = E_max, ar = ar, T_min = T_min, T_max = T_max, N_f = N_f, U_loss_tank = U_loss_tank);
...
annotation(
    Icon(graphics = {Text(origin = {7, -16}, extent = {{-49, 42}, {35, -10}}, textString = "TC"), Text(origin = {-62, 11}, extent = {{-8, 3}, {8, -3}}, textString = "T_amb"), Text(origin = {62, 12}, extent = {{-8, 6}, {8, -6}}, textString = "p_amb"), Text(origin = {-52, -65}, extent = {{-28, 3}, {28, -3}}, textString = "h_bot_outlet"), Text(origin = {48, -63}, extent = {{-18, 5}, {24, -9}}, textString = "T_bot_measured"), Text(origin = {49, 70}, extent = {{-15, 4}, {25, -12}}, textString = "T_top_measured"), Text(origin = {18, 80}, extent = {{-12, 4}, {12, -4}}, textString = "fluid_a"), Text(origin = {18, -80}, extent = {{-12, 4}, {12, -4}}, textString = "fluid_b"), Text(origin = {50, 35.5}, extent = {{-6, 2.5}, {10, -7.5}}, textString = "T_95%"), Text(origin = {50, -26.5}, extent = {{-6, 2.5}, {10, -7.5}}, textString = "T_05%")}, coordinateSystem(initialScale = 0.1)), Documentation(revisions ="<html>
...
end Thermocline_Fluid_SingleTank_Final;