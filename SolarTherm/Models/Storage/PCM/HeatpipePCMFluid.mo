...
//-----------------------------------------------------------------------
    ...
    annotation (Placement(visible = true, transformation(origin = {108, 90},extent = {{-18, -18}, {18, 18}}, rotation = 0), iconTransformation(origin = {108, 90},extent = {{-18, -18}, {18, 18}}, rotation = 0)));
...
protected
	...
	Modelica.Blocks.Interfaces.RealInput T_amb annotation (Placement(
        ...
        origin={0, 204},extent={{-12,-12},{12,12}},
...
//Interface Equations
    ...
    //FluidPorts
    HTF_br.T = T_HTF; //fluid flowing to receiver is at HTF temperatur
    HTF_bp.T = T_HTF;
    HTF_br.x = 0.0; //zero vapor pumped to receiver
    HTF_bp.x = 1.0; //complete vapor pumped to powerblock
    
    fluid_bp.h_outflow = HTF_bp.h;
    fluid_br.h_outflow = HTF_br.h;

    fluid_ar.h_outflow=0.0;//inStream(fluid_ar.h_outflow);//0.0;
    fluid_ap.h_outflow=0.0;//inStream(fluid_ap.h_outflow);//0.0;
