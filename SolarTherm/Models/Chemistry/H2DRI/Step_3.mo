...
model Step_3
  ...
  //    A              B                                           C             D
  //(1.0)FeO(s) + (1.0)H2(g) ---DeltaH_rxn (J/molrxn) ---> (1.0)Fe(s) + (1.0)H2O at different temperatures.
  //H2O is at the most stable state at whatever temperature is defined.
  
  //Chemistry Tables
  Chemical Chem_A=SolarTherm.Models.Chemistry.ChemTable.FeO;// "Standard thermodynamic constants for A";
  Chemical Chem_B=SolarTherm.Models.Chemistry.ChemTable.H2;// "Standard thermodynamic constants for B";
  Chemical Chem_C=SolarTherm.Models.Chemistry.ChemTable.Fe;// "Standard thermodynamic constants for C";
  Chemical Chem_D=SolarTherm.Models.Chemistry.ChemTable.H2O;// "Standard thermodynamic constants for D";
  
  //Stochiometric Ratio
  parameter Real n_A = 1.0 "Moles of A per moles of reaction (mol/molrxn)";
  parameter Real n_B = 1.0 "Moles of B per moles of reaction (mol/molrxn)";
  parameter Real n_C = 1.0 "Moles of C per moles of reaction (mol/molrxn)";
  parameter Real n_D = 1.0 "Moles of D per moles of reaction (mol/molrxn)";
...
equation
  ...
  h_A = SolarTherm.Media.SolidParticles.FeO_utilities.h_T(T);
  s_refA = SolarTherm.Media.SolidParticles.FeO_utilities.s_T(T_ref);
  s_A = SolarTherm.Media.SolidParticles.FeO_utilities.s_T(T);
  ...
  h_C = SolarTherm.Media.SolidParticles.Fe_utilities.h_T(T);
  s_refC = SolarTherm.Media.SolidParticles.Fe_utilities.s_T(T_ref);
  s_C = SolarTherm.Media.SolidParticles.Fe_utilities.s_T(T);
