...
model Step_2
  ...
  //    A              B                                           C             D
  //(1/3)Fe3O4(s) + (1/3)H2(g) ---DeltaH_rxn (J/molrxn) ---> (1.0)FeO(s) + (1/3)H2O at different temperatures.
  //H2O is at the most stable state at whatever temperature is defined.
  
  //Chemistry Tables
  Chemical Chem_A=SolarTherm.Models.Chemistry.ChemTable.Fe3O4;
  Chemical Chem_B=SolarTherm.Models.Chemistry.ChemTable.H2;//"Standard thermodynamic constants for B";
  Chemical Chem_C=SolarTherm.Models.Chemistry.ChemTable.FeO;//"Standard thermodynamic constants for C";
