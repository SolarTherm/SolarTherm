...
model Overall_Rxn
  ...
  //    A            B                                      C          D
  //0.5Fe2O3(s) + 1.5H2(g) ---DeltaH_rxn (J/molrxn) ---> 1.0Fe(s) + 1.5H2O at different temperatures.
  ...
  parameter Real n_B = 1.5 "Moles of B to moles of reaction (mol/molrxn)";
  parameter Real n_C = 1.0 "Moles of C to moles of reaction (mol/molrxn)";
  parameter Real n_D = 1.5 "Moles of D to moles of reaction (mol/molrxn)";
