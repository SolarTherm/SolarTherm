...
// Interpolate
  ...
  model ParticleGasHX_TestRig
    ...
    Modelica.Blocks.Sources.RealExpression realExpression(y = 1603.42) annotation(
      Placement(visible = true, transformation(origin = {-126, 106}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Blocks.Sources.RealExpression realExpression1(y = 298.15) annotation(
      Placement(visible = true, transformation(origin = {-72, 94}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    ...
    connect(realExpression.y, lift.m_flow) annotation(
      Line(points = {{-114, 106}, {-98, 106}, {-98, 60}, {-98, 60}}, color = {0, 0, 127}));
    connect(L_hot_tank.y, HX.L_hot_tank) annotation(
      Line(points = {{-60, 106}, {2, 106}, {2, 12}, {28, 12}}, color = {0, 0, 127}));
    ...
    connect(realExpression1.y, HX.T_amb) annotation(
      Line(points = {{-60, 94}, {-10, 94}, {-10, 12}, {-8, 12}}, color = {0, 0, 127}));
    annotation(
