...
// Interpolate
  ...
  model Test_Cost_Function_Storage_G3P3
    ...
    parameter Real D_bin = 20.9;
    parameter Real D_outlet = 0.21;
    parameter Real t_stg = 6;
    parameter Real m_dot_PB_des = 10865191;
    ...
    Real C_storage_in;
  equation
    C_storage_system = SolarTherm.Utilities.G3P3StorageCostFunction(H_bin, D_bin, D_outlet, t_stg, m_dot_PB_des, c);
    C_storage_in = SolarTherm.Utilities.G3P3StorageCostFunction_Integrated(H_tower, D_tower_out, m_tot, D_outlet_int, c);
    annotation(
      experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-06, Interval = 0.002));
  end Test_Cost_Function_Storage_G3P3;
end Validation;