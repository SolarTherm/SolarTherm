...
model SystemAnalysis_losses
  ...
  Models.CSP.CRS.HeliostatsField.HeliostatsField heliostatsField(
    ...
    use_defocus=true,
    Q_defocus=3.24e8,
    redeclare model Optical = Models.CSP.CRS.HeliostatsField.Optical.Function)
  ...
  Modelica.Blocks.Sources.RealExpression DNI_input(y = data.DNI) annotation(Placement(transformation(extent={{-136,60},
            {-116,80}})));
  Modelica.Blocks.Sources.RealExpression Tamb_input(y = data.Tdew) annotation(Placement(transformation(extent={{-52,70},
            {-32,90}})));
...
equation
  ...
  connect(Tamb_input.y, receiver.Tamb) annotation(Line(points={{-31,80},{-24,80},
  ...
  connect(Pres_input.y, tankHot.p_top)
    annotation (Line(points={{1,68},{30.5,68},{30.5,59.7}}, color={0,0,127}));
  connect(Pres_input.y, tankCold.p_top) annotation (Line(points={{1,68},{6,68},
          {6,32},{49.5,32},{49.5,-8.3}},    color={0,0,127}));
  ...
  connect(Tamb_input.y, tankHot.T_amb) annotation (Line(points={{-31,80},{0,80},
          {21.9,80},{21.9,59.7}}, color={0,0,127}));
  connect(tankCold.T_amb, receiver.Tamb) annotation (Line(points={{58.1,-8.3},{
          58.1,26},{-2,26},{-2,42},{-24,42},{-24,36.04}}, color={0,0,127}));
