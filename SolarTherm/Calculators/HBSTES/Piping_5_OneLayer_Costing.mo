...
model Piping_5_OneLayer_Costing
  ...
  parameter SI.Temperature T_max = 1400.00 + 273.15;
  ...
  parameter SI.Temperature T1 = T_piping5_max "Inner Pipe temperature (K)";
  parameter SI.MassFlowRate m_flow_gas = m_flow_piping5_max "Maximum mass flow rate of air (kg/s)";
