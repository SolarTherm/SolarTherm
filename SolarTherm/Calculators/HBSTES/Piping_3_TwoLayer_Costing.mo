...
model Piping_3_TwoLayer_Costing
  ...
  //Input Parameters
  parameter Real HM = 3.3; //Heater Multiple
  parameter SI.Temperature T_max = 1380.00 + 273.15;
  ...
  parameter SI.Temperature T1 = T_piping3_max "Inner Pipe temperature (K)";
  parameter SI.MassFlowRate m_flow_gas = m_flow_piping3_max "Maximum mass flow rate of air (kg/s)";
  
  parameter SI.Temperature T2_Max = 1200.0 + 273.15 "Maximum tolerable insulation temperature (K)";
...
*/
  ...
  parameter Real c1 = 6603.47 "Cost per unit volume of  Refractory (USD_2022)";
