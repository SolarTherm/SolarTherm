...
model Piping_4_TwoLayer_Costing
  ...
  //Default Pressure
  parameter SI.Pressure p_des = 100.0e3;
  //Default pressure of 1 bar
  //Input Parameters
  parameter Real HM = 2.0;
  //Heater Multiple
  ...
  parameter SI.Temperature T1 = T_piping4_max "Inner Pipe temperature (K)";
  parameter SI.MassFlowRate m_flow_gas = m_flow_piping4_max "Maximum mass flow rate of air (kg/s)";
