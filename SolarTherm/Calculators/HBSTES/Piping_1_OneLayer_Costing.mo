...
model Piping_1_OneLayer_Costing
  ...
  parameter SI.Temperature T1 = T_piping1_max "Inner Pipe temperature (K)";
  parameter SI.MassFlowRate m_flow_gas = m_flow_piping1_max "Maximum mass flow rate of air (kg/s)";
