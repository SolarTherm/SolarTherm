...
model Radial_Insulation_SodiumBoiler_Downcomer
  ...
  //Inputs
  parameter Real d1 = 0.864 "Pipe diameter";
  parameter Real QpL = 1e-2*4.0485e6/86.7315 "Acceptable Heat Rate per unit m (currently 0.1% of design receiver heat)";
...
end Radial_Insulation_SodiumBoiler_Downcomer;