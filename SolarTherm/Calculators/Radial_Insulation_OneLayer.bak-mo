...
model Radial_Insulation_OneLayer
  import SI = Modelica.SIunits;
  import CN = Modelica.Constants;
  import MA = Modelica.Blocks.Math;
  
  //Design parameters
  parameter SI.Temperature T1 = 450.0 + 273.15 "Inner Pipe temperature (K)";
  parameter SI.MassFlowRate m_flow_gas = 75.5 "Maximum gas (kg/s)";
  
  parameter SI.Temperature T2_Max = 50.0+273.15;
  ...
  parameter Real c1 = 108.0 "Cost per unit volume of Insulation (USD)";
  ...
  //parameter SI.Temperature T2_Max = 900.0 + 273.15 "Maximum tolerable insulation temperature (K)";
  ...
  SI.Length d2 = 2.0 * r2 "Total pipe diameter, including the insulating layers (m)";
  ...
  //Calculation
  SI.Temperature T2;
  parameter SI.Temperature T3 = 25.0+273.15;
