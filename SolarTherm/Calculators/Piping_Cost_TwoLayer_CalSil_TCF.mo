...
model Piping_Cost_TwoLayer_CalSil_TCF
  import SI = Modelica.SIunits;
  import CN = Modelica.Constants;
  import MA = Modelica.Blocks.Math;
  
  //Input Parameters
  parameter SI.Temperature T1 = 1250.0 + 273.15 "Inner Pipe temperature (K)";
  parameter SI.MassFlowRate m_flow_gas = 54.8 "Maximum mass flow rate of air (kg/s)";  
  
  parameter SI.Temperature T2_Max = 1000.0 + 273.15 "Maximum tolerable insulation temperature (K)";
...
end Piping_Cost_TwoLayer_CalSil_TCF;