...
model HX_Load_Calculation2 "Calculates the heat exchanger load and checks temperature profiles"
  import SI = Modelica.SIunits;
  import CN = Modelica.Constants;
  import MA = Modelica.Blocks.Math;
  replaceable package Medium_Hot = SolarTherm.Media.Thermo;
  replaceable package Medium_Cold = Modelica.Media.Water.WaterIF97_ph;
  //Process input fluid
  //Discretisation
...
//state_C.
  annotation(
    ...
    experiment(StopTime = 120, StartTime = 0, Tolerance = 1.0e-5, Interval = 1, maxStepSize = 1, initialStepSize = 1));
end HX_Load_Calculation2;