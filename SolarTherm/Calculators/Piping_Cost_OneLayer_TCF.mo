...
model Piping_Cost_OneLayer_TCF
  import SI = Modelica.SIunits;
  import CN = Modelica.Constants;
  import MA = Modelica.Blocks.Math;
  //Input Parameters
  parameter SI.Temperature T1 = 317.3 + 273.15 "Inner Pipe temperature (K)";
  parameter SI.MassFlowRate m_flow_gas = 3.6 "Maximum mass flow rate of air (kg/s)";
  parameter SI.Temperature T2_Max = 50.0 + 273.15 "Maximum tolerable insulation temperature (K)";
