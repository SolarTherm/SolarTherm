...
function h_T "Specific enthalpy (J/kg) of H2 at ambient pressure as a function of temperature (reference 0 J/kg at 298.15K)"
...
algorithm
	h := Utilities.Interpolation.Interpolate1D(T_data,h_data,T);
end h_T;