within SolarTherm.Media.Nara_airish;
...
package Air_amb_p "Air, explicit in h"
  /* For a new medium, make a copy of this package and remove
  	...
  	*/
  extends Modelica.Media.Interfaces.PartialMedium(ThermoStates = Modelica.Media.Interfaces.Choices.IndependentVariables.ph, final mediumName = "Air", final substanceNames = {"Air"}, final singleState = false, final reducedX = true, final fixedX = true, Temperature(min = 100.0, max = 3000.0, start = 800.0));
