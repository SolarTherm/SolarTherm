...
package Fe2O3H2O_ph
	...
	*/
	...
	extends Modelica.Media.Interfaces.PartialMedium(
		...
		final mediumName="Fe2O3H2O",
		final substanceNames={"Fe2O3H2O"},
	...
	import SolarTherm.Media.SolidParticles.Fe2O3H2O_utilities.*;
	...
	*/
	...
	annotation (Documentation(info= "<html><head></head><body><p><span style=\"font-family: Arial,sans-serif;\">Calculation of thermo-physical properties for pure solid Fe2O3.H2O (goethite) in the temperature region of 298.15 K to 1500 K at its most stable phase at 1 bar. Properties have been extrapolated for temperatures above 400 K. Thermodynamic properties are explicit in terms of enthalpy and pressure. Properties are calculated via linear interpolation of data-tables with 10 K temperature intervals.
		</span></p><p><b><span style=\"font-family: Arial, sans-serif;\"></span></b></p><div><b style=\"font-family: 'DejaVu Sans Mono';\"><span style=\"font-family: Arial, sans-serif;\">Restrictions</span></b><div style=\"font-family: 'DejaVu Sans Mono'; font-weight: normal;\"><span style=\"font-family: Arial, sans-serif;\"><br></span></div><div style=\"font-family: 'DejaVu Sans Mono'; font-weight: normal;\"><span style=\"font-family: Arial, sans-serif;\">The functions provided by this package shall be used inside of the restricted limits according to the referenced literature.</span><ul><li><b><span style=\"font-family: Arial, sans-serif;\">298.15 K ≤ T ≤ 400 K</span></b></li><li><b><span style=\"font-family: Arial, sans-serif;\">Explicit for pressure and enthalpy.</span></b></li></ul><div><font face=\"Arial, sans-serif\">The following sources were used:</font></div><div><ul><li><font face=\"Arial, sans-serif\"><b>cp, h, s: FactSage</b></font></li><li><font face=\"Arial, sans-serif\"><b>rho: Suzuki 2007</b></font></li><li><font face=\"Arial, sans-serif\"><b>k: Beygelzimer, assumed equal to Fe2O3</b></font></li></ul><div><font face=\"Arial, sans-serif\">The following phases were considered in this model:</font></div></div><div><ul><li><font face=\"Arial, sans-serif\"><b>S1 : 298.15 K - 400.0 K</b></font></li></ul><div><font face=\"Arial, sans-serif\">Specific enthalpy,&nbsp;</font><i style=\"font-family: Arial, sans-serif;\">h</i><span style=\"font-family: Arial, sans-serif;\">(</span><i style=\"font-family: Arial, sans-serif;\">T</i><span style=\"font-family: Arial, sans-serif;\">)</span><span style=\"font-family: Arial, sans-serif;\">&nbsp;[J/kg] measured with respect to phase S1 at 298.15 K.</span></div></div><div><font face=\"Arial, sans-serif\">Specific absolute entropy,&nbsp;<i>s</i>(<i>T</i>) [J/kgK] provided as an absolute measurement.</font></div><p><b><span style=\"font-family: Arial, sans-serif;\">References</span></b></p><p style=\"margin-left: 30px;\">C. W. Bale, E. Bélisle, P. Chartrand, S. A. Decterov, G. Eriksson, A.E. Gheribi, K. Hack, I. H. Jung, Y. B. Kang, J. Melançon, A. D. Pelton, S. Petersen, C. Robelin. J. Sangster, P. Spencer and M-A. Van Ende, FactSage Thermochemical Software and Databases - 2010 - 2016, Calphad, vol. 54, pp 35-53, 2016 &lt;www.factsage.com&gt;</p><p style=\"margin-left: 30px;\">A. Suzuki, Thermal equation of state of goethite (alpha-FeOOH), High Pressure Research, vol. 37, no. 2, pp 193-199. 2017.</p><p style=\"margin-left: 30px;\"><span style=\"font-size: 12px;\">Emmanuil Beygelzimer and Yan Beygelzimer. Thermal conductivity of oxide scale and its com- ponents in the range from 0 C to 1300 C: Generalized estimates with account for movability of phase transitions, October 2021.</span></p></div></div><div>
		</div></body></html>"));
end Fe2O3H2O_ph;