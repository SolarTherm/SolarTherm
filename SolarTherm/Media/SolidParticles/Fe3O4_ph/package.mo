...
package Fe3O4_ph
  /* The statement below extends from PartialMedium and sets some
  	...
  	*/
  extends Modelica.Media.Interfaces.PartialMedium(ThermoStates = Modelica.Media.Interfaces.Choices.IndependentVariables.ph, final mediumName = "Fe3O4", final substanceNames = {"Fe3O4"}, final singleState = false, final reducedX = true, final fixedX = true, Temperature(min = 298.15, max = 1812.0, start = 900 + 273.15));
