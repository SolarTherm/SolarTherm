...
function Pr_T "Prandtl number of air at ambient pressue as a function of temperature"
...
algorithm
    Pr := SolarTherm.Utilities.Interpolation.Interpolate1D(T_data,alpha_data,T);
end Pr_T;