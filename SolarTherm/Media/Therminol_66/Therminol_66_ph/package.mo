within SolarTherm.Media.Therminol_66;

package Therminol_66_ph "Dowtherm explicit in h"
  /* For a new medium, make a copy of this package and remove
    	...
    	*/
  extends Modelica.Media.Interfaces.PartialMedium(ThermoStates = Modelica.Media.Interfaces.Choices.IndependentVariables.ph, final mediumName = "Therminol_66", final substanceNames = {"Therminol_66"}, final singleState = false, final reducedX = true, final fixedX = true, Temperature(min = -3.0 + 273.15, max = 345.0 + 273.15, start = 25.0 + 273.15));
  //import SolarTherm.Media.MoltenSalt.MoltenSalt_utilities.*;
  import SolarTherm.Media.Therminol_66.Therminol_66_ph_utilities.*;
  ...
  /* Provide an implementation of model BaseProperties,
    		...
    		the gas constant R and the DowthermAmolar mass MM of the medium.
