within SolarTherm.Media.ChlorideSaltPH;
package ChlorideSaltPH_ph "Chloride Salt model, explicit in p and h"
	...
	*/
	...
	extends Modelica.Media.Interfaces.PartialMedium(
		...
		final substanceNames={"KCl", "NaCl", "MgCl2", "other"}, // Molar fractions: 83%, 5%, 7%, 3.5% and 1.5%
