...
//package Sodium "Basic sodium model"
...
//		final singleState=true, // single state if u and d indepedent of p
//		final reducedX=true,
//		final fixedX=true,
//		Temperature( // redefining all bounds for Temperature (in parent Types package)
//			min=370.9, // melting point
//			max=1154.7, // boiling point for 1 atm
//			start=700,
//			nominal=700
//			)
//		);
