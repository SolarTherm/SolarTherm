...
package DowthermA_ph "Dowtherm explicit in h"
  /* For a new medium, make a copy of this package and remove
  	...
  	*/
  extends Modelica.Media.Interfaces.PartialMedium(ThermoStates = Modelica.Media.Interfaces.Choices.IndependentVariables.ph, final mediumName = "DowthermA", final substanceNames = {"DowthermA"}, final singleState = false, final reducedX = true, final fixedX = true, Temperature(min = 12.0+273.15, max = 450.0+273.15, start = 25.0+273.15));
  //import SolarTherm.Media.MoltenSalt.MoltenSalt_utilities.*;
  import SolarTherm.Media.DowthermA.DowthermA_ph_utilities.*;
